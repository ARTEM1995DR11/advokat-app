const CACHE = 'advokat-iphone-offline-v31-restyle-3137';
const SHELL = [
  './',
  './index.html',
  './styles-3137.css',
  './app-3137.js',
  './manifest-3137.webmanifest?v=3137',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3137.js') || url.pathname.endsWith('/styles-3137.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
