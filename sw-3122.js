const CACHE = 'advokat-iphone-offline-v31-restyle-3122';
const SHELL = [
  './',
  './index.html',
  './styles-3122.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3122.js') || url.pathname.endsWith('/styles-3122.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
