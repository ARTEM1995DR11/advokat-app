const CACHE = 'advokat-iphone-offline-v31-restyle-3135';
const SHELL = [
  './',
  './index.html',
  './styles-3135.css',
  './app-3135.js',
  './manifest-3135.webmanifest?v=3135',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3135.js') || url.pathname.endsWith('/styles-3135.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
