const CACHE = 'advokat-iphone-offline-v31-restyle-3121';
const SHELL = [
  './',
  './index.html',
  './styles-3121.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3121.js') || url.pathname.endsWith('/styles-3121.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
