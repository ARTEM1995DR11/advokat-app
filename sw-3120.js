const CACHE = 'advokat-iphone-offline-v31-restyle-3120';
const SHELL = [
  './',
  './index.html',
  './styles-3120.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3120.js') || url.pathname.endsWith('/styles-3120.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
