...
function editTask(t,preset){
  ED = t ? JSON.parse(JSON.stringify(t))
    : Object.assign({ id:null,title:'',mid:'',note:'',due:'',time:'',place:'',pri:'mid',kind:'task',sourceDate:'',rule:'',ruleCode:'',ruleArticle:'',deadlineCode:'GPK',deadlineRuleId:'gpk-appeal',hearingClient:'',hearingNumber:'',
...
function drawEditor(){
  ...
  var title = hearing ? (isNew?'Новое заседание':'Редактирование заседания') : (t.kind==='deadline' ? (isNew?'Новый процессуальный срок':'Редактирование срока') : (isNew?'Новая задача':'Редактирование задачи'));
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=3139" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
  ...
  (t.kind!=='deadline'?('<div class="two task-datetime">'+
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw-3139.js', {updateViaCache:'none'}).then(function(reg){
