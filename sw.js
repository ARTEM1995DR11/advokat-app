const CACHE = 'advokat-iphone-offline-v121-premium-5471';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5471',
  './new-matter-client.css?v=5471',
  './new-matter-stage.css?v=5471',
  './app.js?v=5471',
  './manifest.webmanifest?v=5471',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5471',
  './bg-new-matter-approved.webp?v=5471',
  './nm-folder-mockup.png?v=5471',
  './nm-scale-mockup.png?v=5471',
  './nm-doc-mockup.png?v=5471',
