const CACHE = 'advokat-iphone-offline-v121-premium-5440';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5440',
  './bg-new-matter-approved.webp?v=5440',
  './nm-folder-mockup.png?v=5440',
  './nm-scale-mockup.png?v=5440',
  './nm-doc-mockup.png?v=5440',
