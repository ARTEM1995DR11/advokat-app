const CACHE = 'advokat-iphone-offline-v121-premium-5472';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5472',
  './new-matter-client.css?v=5472',
  './new-matter-stage.css?v=5472',
  './app.js?v=5472',
  './manifest.webmanifest?v=5472',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5472',
  './bg-new-matter-approved.webp?v=5472',
  './nm-folder-mockup.png?v=5472',
  './nm-scale-mockup.png?v=5472',
  './nm-doc-mockup.png?v=5472',
