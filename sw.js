const CACHE = 'advokat-iphone-offline-v121-premium-5477';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5477',
  './new-matter-client.css?v=5477',
  './new-matter-stage.css?v=5477',
  './new-matter-values.css?v=5477',
  './app.js?v=5477',
  './manifest.webmanifest?v=5477',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5477',
  './bg-new-matter-approved.webp?v=5477',
  './nm-folder-mockup.png?v=5477',
  './nm-scale-mockup.png?v=5477',
  './nm-doc-mockup.png?v=5477',
