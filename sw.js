const CACHE = 'advokat-iphone-offline-v46-premium-5212';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5212',
  './app.js?v=5212',
  './manifest.webmanifest?v=5212',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5212',
  './quick-sheet-marble-approved.webp?v=5212',
  './quick-sheet-mobile-approved-v5211.webp?v=5212',
  './columns-light.png?v=5212',
  './header-bell-premium.png?v=5212',
  './header-search-premium.png?v=5212',
  './global-search-head-motif-v173.png?v=5212',
  './nav-panel-light.png',
  './nav-active-base.png?v=5212',
  './nav-active-today.png?v=5212',
  './fab-plus-square-premium.png?v=5212',
  './VERSION.txt'
];
