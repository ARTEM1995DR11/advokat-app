const CACHE = 'advokat-iphone-offline-v121-premium-5520';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5520',
  './cases-folders.css?v=5520',
  './new-matter-client.css?v=5520',
  './new-matter-stage.css?v=5520',
  './new-matter-values.css?v=5520',
  './new-matter-save.css?v=5520',
  './app.js?v=5520',
  './manifest.webmanifest?v=5520',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5520',
  ...
  './header-filter-premium.png?v=5520',
  './bg-new-matter-approved.webp?v=5520',
  './nm-folder-mockup.png?v=5520',
  './nm-scale-mockup.png?v=5520',
  './nm-doc-mockup.png?v=5520',
