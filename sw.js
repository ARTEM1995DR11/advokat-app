const CACHE = 'advokat-iphone-offline-v125-premium-5541';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5541',
  './cases-folders.css?v=5541',
  './new-matter-client.css?v=5541',
  './new-matter-stage.css?v=5541',
  './new-matter-values.css?v=5541',
  './new-matter-save.css?v=5541',
  './app.js?v=5541',
  './manifest.webmanifest?v=5541',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5541',
  ...
  './header-filter-premium.png?v=5541',
  './bg-new-matter-approved.webp?v=5541',
  './nm-folder-mockup.png?v=5541',
  './nm-scale-mockup.png?v=5541',
  './nm-doc-mockup.png?v=5541',
