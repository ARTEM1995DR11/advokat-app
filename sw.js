const CACHE = 'advokat-iphone-offline-v40-stable-5058';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5058',
  './nav-panel-light.png',
  './nav-panel-dark.png',
  './nav-active-base.png?v=5058',
  './nav-active-today.png?v=5058',
  './nav-active-tasks.png?v=5058',
  './nav-active-cases.png?v=5058',
  './nav-active-calendar.png?v=5058',
  './nav-active-more.png?v=5058',
  './app.js?v=5058',
  './manifest.webmanifest?v=5058',
