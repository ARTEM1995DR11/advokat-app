const CACHE = 'advokat-iphone-offline-v121-premium-5450';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5450',
  './bg-new-matter-approved.webp?v=5450',
  './nm-folder-mockup.png?v=5450',
  './nm-scale-mockup.png?v=5450',
  './nm-doc-mockup.png?v=5450',
