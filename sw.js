const CACHE = 'advokat-iphone-offline-v121-premium-5446';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5446',
  './bg-new-matter-approved.webp?v=5446',
  './nm-folder-mockup.png?v=5446',
  './nm-scale-mockup.png?v=5446',
  './nm-doc-mockup.png?v=5446',
