const CACHE = 'advokat-iphone-offline-v121-premium-5463';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5463',
  './bg-new-matter-approved.webp?v=5463',
  './nm-folder-mockup.png?v=5463',
  './nm-scale-mockup.png?v=5463',
  './nm-doc-mockup.png?v=5463',
