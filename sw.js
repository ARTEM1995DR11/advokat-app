const CACHE = 'advokat-iphone-offline-v121-premium-5503';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5503',
  './cases-folders.css?v=5503',
  './new-matter-client.css?v=5503',
  './new-matter-stage.css?v=5503',
  './new-matter-values.css?v=5503',
  './new-matter-save.css?v=5503',
  './app.js?v=5503',
  './manifest.webmanifest?v=5503',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5503',
  ...
  './header-filter-premium.png?v=5503',
  './bg-new-matter-approved.webp?v=5503',
  './nm-folder-mockup.png?v=5503',
  './nm-scale-mockup.png?v=5503',
  './nm-doc-mockup.png?v=5503',
