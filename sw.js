const CACHE = 'advokat-iphone-offline-v121-premium-5505';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5505',
  './cases-folders.css?v=5505',
  './new-matter-client.css?v=5505',
  './new-matter-stage.css?v=5505',
  './new-matter-values.css?v=5505',
  './new-matter-save.css?v=5505',
  './app.js?v=5505',
  './manifest.webmanifest?v=5505',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5505',
  ...
  './header-filter-premium.png?v=5505',
  './bg-new-matter-approved.webp?v=5505',
  './nm-folder-mockup.png?v=5505',
  './nm-scale-mockup.png?v=5505',
  './nm-doc-mockup.png?v=5505',
