const CACHE = 'advokat-iphone-offline-v40-stable-5060';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5060',
  './nav-panel-light.png',
  './nav-active-base.png?v=5060',
  './nav-active-today.png?v=5060',
  './nav-active-tasks.png?v=5060',
  './nav-active-cases.png?v=5060',
  './nav-active-calendar.png?v=5060',
  './nav-active-more.png?v=5060',
  './app.js?v=5060',
  './manifest.webmanifest?v=5060',
