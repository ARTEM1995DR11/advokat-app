const CACHE = 'advokat-iphone-offline-v121-premium-5507';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5507',
  './cases-folders.css?v=5507',
  './new-matter-client.css?v=5507',
  './new-matter-stage.css?v=5507',
  './new-matter-values.css?v=5507',
  './new-matter-save.css?v=5507',
  './app.js?v=5507',
  './manifest.webmanifest?v=5507',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5507',
  ...
  './header-filter-premium.png?v=5507',
  './bg-new-matter-approved.webp?v=5507',
  './nm-folder-mockup.png?v=5507',
  './nm-scale-mockup.png?v=5507',
  './nm-doc-mockup.png?v=5507',
