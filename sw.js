const CACHE = 'advokat-iphone-offline-v40-stable-5144';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5144',
  './nav-panel-light.png',
  './nav-active-base.png?v=5144',
  './nav-active-today.png?v=5144',
  './nav-active-tasks.png?v=5144',
  './nav-active-cases.png?v=5144',
  './nav-active-calendar.png?v=5144',
  './nav-active-more.png?v=5144',
  './app.js?v=5144',
  './manifest.webmanifest?v=5144',
  ...
  './header-bell-premium.png?v=5144',
  './header-search-premium.png?v=5144',
  './quick-sheet-marble-approved.png?v=5144',
  './quick-icon-hearing.png?v=5144',
  './quick-icon-meeting.png?v=5144',
  './quick-icon-deadline.png?v=5144',
  './quick-icon-task.png?v=5144',
  './quick-icon-journal.png?v=5144',
  './search-medallion.png?v=5144',
  './reminder-head-motif-exact.png?v=5144',
  './reminder-footer-scales-exact.png?v=5144',
  './VERSION.txt'
];
