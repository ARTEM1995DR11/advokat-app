const CACHE = 'advokat-iphone-offline-v122-premium-5532';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5532',
  './cases-folders.css?v=5532',
  './new-matter-client.css?v=5532',
  './new-matter-stage.css?v=5532',
  './new-matter-values.css?v=5532',
  './new-matter-save.css?v=5532',
  './app.js?v=5532',
  './manifest.webmanifest?v=5532',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5532',
  ...
  './header-filter-premium.png?v=5532',
  './bg-new-matter-approved.webp?v=5532',
  './nm-folder-mockup.png?v=5532',
  './nm-scale-mockup.png?v=5532',
  './nm-doc-mockup.png?v=5532',
