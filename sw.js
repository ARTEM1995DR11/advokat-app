const CACHE = 'advokat-iphone-offline-v121-premium-5464';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5464',
  './bg-new-matter-approved.webp?v=5464',
  './nm-folder-mockup.png?v=5464',
  './nm-scale-mockup.png?v=5464',
  './nm-doc-mockup.png?v=5464',
