const CACHE = 'advokat-iphone-offline-v40-stable-5100';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5100',
  './nav-panel-light.png',
  './nav-active-base.png?v=5100',
  './nav-active-today.png?v=5100',
  './nav-active-tasks.png?v=5100',
  './nav-active-cases.png?v=5100',
  './nav-active-calendar.png?v=5100',
  './nav-active-more.png?v=5100',
  './app.js?v=5100',
  './manifest.webmanifest?v=5100',
  ...
  './header-bell-premium.png?v=5100',
  './header-search-premium.png?v=5100',
  './quick-sheet-marble-approved.png?v=5100',
  './quick-icon-hearing.png?v=5100',
  './quick-icon-meeting.png?v=5100',
  './quick-icon-deadline.png?v=5100',
  './quick-icon-task.png?v=5100',
  './quick-icon-journal.png?v=5100',
  './VERSION.txt'
];
