const CACHE = 'advokat-iphone-offline-v121-premium-5453';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5453',
  './bg-new-matter-approved.webp?v=5453',
  './nm-folder-mockup.png?v=5453',
  './nm-scale-mockup.png?v=5453',
  './nm-doc-mockup.png?v=5453',
