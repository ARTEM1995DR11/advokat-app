const CACHE = 'advokat-iphone-offline-v121-premium-5516';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5516',
  './cases-folders.css?v=5516',
  './new-matter-client.css?v=5516',
  './new-matter-stage.css?v=5516',
  './new-matter-values.css?v=5516',
  './new-matter-save.css?v=5516',
  './app.js?v=5516',
  './manifest.webmanifest?v=5516',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5516',
  ...
  './header-filter-premium.png?v=5516',
  './bg-new-matter-approved.webp?v=5516',
  './nm-folder-mockup.png?v=5516',
  './nm-scale-mockup.png?v=5516',
  './nm-doc-mockup.png?v=5516',
