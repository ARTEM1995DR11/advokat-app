const CACHE = 'advokat-iphone-offline-v121-premium-5512';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5512',
  './cases-folders.css?v=5512',
  './new-matter-client.css?v=5512',
  './new-matter-stage.css?v=5512',
  './new-matter-values.css?v=5512',
  './new-matter-save.css?v=5512',
  './app.js?v=5512',
  './manifest.webmanifest?v=5512',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5512',
  ...
  './header-filter-premium.png?v=5512',
  './bg-new-matter-approved.webp?v=5512',
  './nm-folder-mockup.png?v=5512',
  './nm-scale-mockup.png?v=5512',
  './nm-doc-mockup.png?v=5512',
