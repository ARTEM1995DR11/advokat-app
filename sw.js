const CACHE = 'advokat-iphone-offline-v121-premium-5417';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5417',
  './bg-new-matter-approved.webp?v=5417',
  './nm-folder-mockup.png?v=5417',
  './nm-scale-mockup.png?v=5417',
  './nm-doc-mockup.png?v=5417',
