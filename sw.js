const CACHE = 'advokat-iphone-offline-v121-premium-5482';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5482',
  './new-matter-client.css?v=5482',
  './new-matter-stage.css?v=5482',
  './new-matter-values.css?v=5482',
  './new-matter-save.css?v=5482',
  './app.js?v=5482',
  './manifest.webmanifest?v=5482',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5482',
  ...
  './header-filter-premium.png?v=5482',
  './bg-new-matter-approved.webp?v=5482',
  './nm-folder-mockup.png?v=5482',
  './nm-scale-mockup.png?v=5482',
  './nm-doc-mockup.png?v=5482',
