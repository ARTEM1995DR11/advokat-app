const CACHE = 'advokat-iphone-offline-v121-premium-5418';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5418',
  './bg-new-matter-approved.webp?v=5418',
  './nm-folder-mockup.png?v=5418',
  './nm-scale-mockup.png?v=5418',
  './nm-doc-mockup.png?v=5418',
