const CACHE = 'advokat-iphone-offline-v56-premium-5226';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5226',
  './app.js?v=5226',
  './manifest.webmanifest?v=5226',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5226',
  './quick-sheet-marble-approved.webp?v=5226',
  './quick-sheet-mobile-approved-v5211.webp?v=5226',
  './columns-light.png?v=5226',
  './header-bell-premium.png?v=5226',
  './header-search-premium.png?v=5226',
  './global-search-head-motif-v173.png?v=5226',
  './nav-panel-light.png',
  './nav-active-base.png?v=5226',
  './nav-active-today.png?v=5226',
  './fab-plus-square-premium.png?v=5226',
  './VERSION.txt'
];
