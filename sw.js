const CACHE = 'advokat-iphone-offline-v57-premium-5227';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5227',
  './app.js?v=5227',
  './manifest.webmanifest?v=5227',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5227',
  './quick-sheet-marble-approved.webp?v=5227',
  './quick-sheet-mobile-approved-v5211.webp?v=5227',
  './columns-light.png?v=5227',
  './header-bell-premium.png?v=5227',
  './header-search-premium.png?v=5227',
  './global-search-head-motif-v173.png?v=5227',
  './nav-panel-light.png',
  './nav-active-base.png?v=5227',
  './nav-active-today.png?v=5227',
  './fab-plus-square-premium.png?v=5227',
  './VERSION.txt'
];
