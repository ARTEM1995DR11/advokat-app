const CACHE = 'advokat-iphone-offline-v122-premium-5529';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5529',
  './cases-folders.css?v=5529',
  './new-matter-client.css?v=5529',
  './new-matter-stage.css?v=5529',
  './new-matter-values.css?v=5529',
  './new-matter-save.css?v=5529',
  './app.js?v=5529',
  './manifest.webmanifest?v=5529',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5529',
  ...
  './header-filter-premium.png?v=5529',
  './bg-new-matter-approved.webp?v=5529',
  './nm-folder-mockup.png?v=5529',
  './nm-scale-mockup.png?v=5529',
  './nm-doc-mockup.png?v=5529',
