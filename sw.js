const CACHE = 'advokat-iphone-offline-v121-premium-5488';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5488',
  './cases-folders.css?v=5488',
  './new-matter-client.css?v=5488',
  './new-matter-stage.css?v=5488',
  './new-matter-values.css?v=5488',
  './new-matter-save.css?v=5488',
  './app.js?v=5488',
  './manifest.webmanifest?v=5488',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5488',
  ...
  './header-filter-premium.png?v=5488',
  './bg-new-matter-approved.webp?v=5488',
  './nm-folder-mockup.png?v=5488',
  './nm-scale-mockup.png?v=5488',
  './nm-doc-mockup.png?v=5488',
