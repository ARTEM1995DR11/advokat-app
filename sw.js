const CACHE = 'advokat-iphone-offline-v121-premium-5510';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5510',
  './cases-folders.css?v=5510',
  './new-matter-client.css?v=5510',
  './new-matter-stage.css?v=5510',
  './new-matter-values.css?v=5510',
  './new-matter-save.css?v=5510',
  './app.js?v=5510',
  './manifest.webmanifest?v=5510',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5510',
  ...
  './header-filter-premium.png?v=5510',
  './bg-new-matter-approved.webp?v=5510',
  './nm-folder-mockup.png?v=5510',
  './nm-scale-mockup.png?v=5510',
  './nm-doc-mockup.png?v=5510',
