const CACHE = 'advokat-iphone-offline-v40-stable-5146';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5146',
  './nav-panel-light.png',
  './nav-active-base.png?v=5146',
  './nav-active-today.png?v=5146',
  './nav-active-tasks.png?v=5146',
  './nav-active-cases.png?v=5146',
  './nav-active-calendar.png?v=5146',
  './nav-active-more.png?v=5146',
  './app.js?v=5146',
  './manifest.webmanifest?v=5146',
  ...
  './header-bell-premium.png?v=5146',
  './header-search-premium.png?v=5146',
  './quick-sheet-marble-approved.png?v=5146',
  './quick-icon-hearing.png?v=5146',
  './quick-icon-meeting.png?v=5146',
  './quick-icon-deadline.png?v=5146',
  './quick-icon-task.png?v=5146',
  './quick-icon-journal.png?v=5146',
  './search-medallion.png?v=5146',
  './reminder-head-motif-exact.png?v=5146',
  './reminder-footer-scales-exact.png?v=5146',
  './VERSION.txt'
];
