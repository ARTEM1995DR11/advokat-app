const CACHE = 'advokat-iphone-offline-v121-premium-5438';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5438',
  './bg-new-matter-approved.webp?v=5438',
  './nm-folder-mockup.png?v=5438',
  './nm-scale-mockup.png?v=5438',
  './nm-doc-mockup.png?v=5438',
