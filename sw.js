...
const CORE = [
  ...
  './index.html',
  './styles.css?v=5485',
  './cases-folders.css?v=5485',
  './new-matter-client.css?v=5485',
  './new-matter-stage.css?v=5485',
  './new-matter-values.css?v=5485',
  './new-matter-save.css?v=5485',
  './app.js?v=5485',
  './manifest.webmanifest?v=5485',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5485',
  ...
  './header-filter-premium.png?v=5485',
  './bg-new-matter-approved.webp?v=5485',
  './nm-folder-mockup.png?v=5485',
  './nm-scale-mockup.png?v=5485',
  './nm-doc-mockup.png?v=5485',
