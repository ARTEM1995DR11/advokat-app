const CACHE = 'advokat-iphone-offline-v121-premium-5511';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5511',
  './cases-folders.css?v=5511',
  './new-matter-client.css?v=5511',
  './new-matter-stage.css?v=5511',
  './new-matter-values.css?v=5511',
  './new-matter-save.css?v=5511',
  './app.js?v=5511',
  './manifest.webmanifest?v=5511',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5511',
  ...
  './header-filter-premium.png?v=5511',
  './bg-new-matter-approved.webp?v=5511',
  './nm-folder-mockup.png?v=5511',
  './nm-scale-mockup.png?v=5511',
  './nm-doc-mockup.png?v=5511',
