const CACHE = 'advokat-iphone-offline-v121-premium-5459';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5459',
  './bg-new-matter-approved.webp?v=5459',
  './nm-folder-mockup.png?v=5459',
  './nm-scale-mockup.png?v=5459',
  './nm-doc-mockup.png?v=5459',
