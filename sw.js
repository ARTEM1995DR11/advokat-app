const CACHE = 'advokat-iphone-offline-v121-premium-5502';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5502',
  './cases-folders.css?v=5502',
  './new-matter-client.css?v=5502',
  './new-matter-stage.css?v=5502',
  './new-matter-values.css?v=5502',
  './new-matter-save.css?v=5502',
  './app.js?v=5502',
  './manifest.webmanifest?v=5502',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5502',
  ...
  './header-filter-premium.png?v=5502',
  './bg-new-matter-approved.webp?v=5502',
  './nm-folder-mockup.png?v=5502',
  './nm-scale-mockup.png?v=5502',
  './nm-doc-mockup.png?v=5502',
