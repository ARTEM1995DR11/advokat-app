const CACHE = 'advokat-iphone-offline-v121-premium-5475';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5475',
  './new-matter-client.css?v=5475',
  './new-matter-stage.css?v=5475',
  './app.js?v=5475',
  './manifest.webmanifest?v=5475',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5475',
  './bg-new-matter-approved.webp?v=5475',
  './nm-folder-mockup.png?v=5475',
  './nm-scale-mockup.png?v=5475',
  './nm-doc-mockup.png?v=5475',
