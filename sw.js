const CACHE = 'advokat-iphone-offline-v40-stable-5141';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5141',
  './nav-panel-light.png',
  './nav-active-base.png?v=5141',
  './nav-active-today.png?v=5141',
  './nav-active-tasks.png?v=5141',
  './nav-active-cases.png?v=5141',
  './nav-active-calendar.png?v=5141',
  './nav-active-more.png?v=5141',
  './app.js?v=5141',
  './manifest.webmanifest?v=5141',
  ...
  './header-bell-premium.png?v=5141',
  './header-search-premium.png?v=5141',
  './quick-sheet-marble-approved.png?v=5141',
  './search-medallion.png?v=5141',
  './reminder-head-motif-exact.png?v=5141',
  './reminder-footer-scales-exact.png?v=5141',
  './VERSION.txt'
];
