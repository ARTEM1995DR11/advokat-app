const CACHE = 'advokat-iphone-offline-v40-stable-5145';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5145',
  './nav-panel-light.png',
  './nav-active-base.png?v=5145',
  './nav-active-today.png?v=5145',
  './nav-active-tasks.png?v=5145',
  './nav-active-cases.png?v=5145',
  './nav-active-calendar.png?v=5145',
  './nav-active-more.png?v=5145',
  './app.js?v=5145',
  './manifest.webmanifest?v=5145',
  ...
  './header-bell-premium.png?v=5145',
  './header-search-premium.png?v=5145',
  './quick-sheet-marble-approved.png?v=5145',
  './search-medallion.png?v=5145',
  './reminder-head-motif-exact.png?v=5145',
  './reminder-footer-scales-exact.png?v=5145',
  './VERSION.txt'
];
