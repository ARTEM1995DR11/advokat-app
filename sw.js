const CACHE = 'advokat-iphone-offline-v121-premium-5383';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5383',
  './bg-new-matter-approved-v5383.webp?v=5383',
