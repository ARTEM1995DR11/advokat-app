const CACHE = 'advokat-iphone-offline-v40-stable-5063';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5063',
  './nav-panel-light.png',
  './nav-active-base.png?v=5063',
  './nav-active-today.png?v=5063',
  './nav-active-tasks.png?v=5063',
  './nav-active-cases.png?v=5063',
  './nav-active-calendar.png?v=5063',
  './nav-active-more.png?v=5063',
  './app.js?v=5063',
  './manifest.webmanifest?v=5063',
