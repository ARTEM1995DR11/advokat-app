const CACHE = 'advokat-iphone-offline-v40-stable-5138';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5138',
  './nav-panel-light.png',
  './nav-active-base.png?v=5138',
  './nav-active-today.png?v=5138',
  './nav-active-tasks.png?v=5138',
  './nav-active-cases.png?v=5138',
  './nav-active-calendar.png?v=5138',
  './nav-active-more.png?v=5138',
  './app.js?v=5138',
  './manifest.webmanifest?v=5138',
  ...
  './header-bell-premium.png?v=5138',
  './header-search-premium.png?v=5138',
  './quick-sheet-marble-approved.png?v=5138',
  './search-medallion.png?v=5138',
  './reminder-head-motif-exact.png?v=5138',
  './reminder-footer-scales-exact.png?v=5138',
  './quick-icon-hearing.png?v=5138',
  './quick-icon-meeting.png?v=5138',
  './quick-icon-deadline.png?v=5138',
  './quick-icon-task.png?v=5138',
  './quick-icon-journal.png?v=5138',
  './VERSION.txt'
];
