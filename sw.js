const CACHE = 'advokat-iphone-offline-v121-premium-5457';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5457',
  './bg-new-matter-approved.webp?v=5457',
  './nm-folder-mockup.png?v=5457',
  './nm-scale-mockup.png?v=5457',
  './nm-doc-mockup.png?v=5457',
