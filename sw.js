const CACHE = 'advokat-iphone-offline-v121-premium-5385';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5385',
  './bg-new-matter-approved-v5385.webp?v=5385',
