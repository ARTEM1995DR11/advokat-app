const CACHE = 'advokat-iphone-offline-v121-premium-5497';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5497',
  './cases-folders.css?v=5497',
  './new-matter-client.css?v=5497',
  './new-matter-stage.css?v=5497',
  './new-matter-values.css?v=5497',
  './new-matter-save.css?v=5497',
  './app.js?v=5497',
  './manifest.webmanifest?v=5497',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5497',
  ...
  './header-filter-premium.png?v=5497',
  './bg-new-matter-approved.webp?v=5497',
  './nm-folder-mockup.png?v=5497',
  './nm-scale-mockup.png?v=5497',
  './nm-doc-mockup.png?v=5497',
