...
const CORE = [
  ...
  './index.html',
  './styles.css?v=5484',
  './cases-folders.css?v=5484',
  './new-matter-client.css?v=5484',
  './new-matter-stage.css?v=5484',
  './new-matter-values.css?v=5484',
  './new-matter-save.css?v=5484',
  './app.js?v=5484',
  './manifest.webmanifest?v=5484',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5484',
  ...
  './header-filter-premium.png?v=5484',
  './bg-new-matter-approved.webp?v=5484',
  './nm-folder-mockup.png?v=5484',
  './nm-scale-mockup.png?v=5484',
  './nm-doc-mockup.png?v=5484',
