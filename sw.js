const CACHE = 'advokat-iphone-offline-v124-premium-5538';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5538',
  './cases-folders.css?v=5538',
  './new-matter-client.css?v=5538',
  './new-matter-stage.css?v=5538',
  './new-matter-values.css?v=5538',
  './new-matter-save.css?v=5538',
  './app.js?v=5538',
  './manifest.webmanifest?v=5538',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5538',
  ...
  './header-filter-premium.png?v=5538',
  './bg-new-matter-approved.webp?v=5538',
  './nm-folder-mockup.png?v=5538',
  './nm-scale-mockup.png?v=5538',
  './nm-doc-mockup.png?v=5538',
