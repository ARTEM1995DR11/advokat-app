const CACHE = 'advokat-iphone-offline-v121-premium-5437';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5437',
  './bg-new-matter-approved.webp?v=5437',
  './nm-folder-mockup.png?v=5437',
  './nm-scale-mockup.png?v=5437',
  './nm-doc-mockup.png?v=5437',
