const CACHE = 'advokat-iphone-offline-v121-premium-5521';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5521',
  './cases-folders.css?v=5521',
  './new-matter-client.css?v=5521',
  './new-matter-stage.css?v=5521',
  './new-matter-values.css?v=5521',
  './new-matter-save.css?v=5521',
  './app.js?v=5521',
  ...
  './premium-gold-save-v5249.webp?v=5521',
  ...
  './header-filter-premium.png?v=5521',
  './bg-new-matter-approved.webp?v=5521',
  './nm-folder-mockup.png?v=5521',
  './nm-scale-mockup.png?v=5521',
  './nm-doc-mockup.png?v=5521',
