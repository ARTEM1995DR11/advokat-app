const CACHE = 'advokat-iphone-offline-v40-stable-5052';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5052',
  ...
  './nav-active-today-5052.png',
  './nav-active-tasks-5052.png',
  './nav-active-calendar-5052.png',
  './nav-active-more-5052.png',
  './app.js?v=5052',
  './manifest.webmanifest?v=5052',
