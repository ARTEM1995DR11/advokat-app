const CACHE = 'advokat-iphone-offline-v40-stable-5139';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5139',
  './nav-panel-light.png',
  './nav-active-base.png?v=5139',
  './nav-active-today.png?v=5139',
  './nav-active-tasks.png?v=5139',
  './nav-active-cases.png?v=5139',
  './nav-active-calendar.png?v=5139',
  './nav-active-more.png?v=5139',
  './app.js?v=5139',
  './manifest.webmanifest?v=5139',
  ...
  './header-bell-premium.png?v=5139',
  './header-search-premium.png?v=5139',
  './quick-sheet-marble-approved.png?v=5139',
  './search-medallion.png?v=5139',
  './reminder-head-motif-exact.png?v=5139',
  './reminder-footer-scales-exact.png?v=5139',
  './quick-icon-hearing.png?v=5139',
  './quick-icon-meeting.png?v=5139',
  './quick-icon-deadline.png?v=5139',
  './quick-icon-task.png?v=5139',
  './quick-icon-journal.png?v=5139',
  './VERSION.txt'
];
