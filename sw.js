const CACHE = 'advokat-iphone-offline-v58-premium-5228';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5228',
  './app.js?v=5228',
  './manifest.webmanifest?v=5228',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5228',
  './quick-sheet-marble-approved.webp?v=5228',
  './quick-sheet-mobile-approved-v5211.webp?v=5228',
  './columns-light.png?v=5228',
  './header-bell-premium.png?v=5228',
  './header-search-premium.png?v=5228',
  './global-search-head-motif-v173.png?v=5228',
  './nav-panel-light.png',
  './nav-active-base.png?v=5228',
  './nav-active-today.png?v=5228',
  './fab-plus-square-premium.png?v=5228',
  './VERSION.txt'
];
