const CACHE = 'advokat-iphone-offline-v121-premium-5479';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5479',
  './new-matter-client.css?v=5479',
  './new-matter-stage.css?v=5479',
  './new-matter-values.css?v=5479',
  './new-matter-save.css?v=5479',
  './app.js?v=5479',
  './manifest.webmanifest?v=5479',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5479',
  './bg-new-matter-approved.webp?v=5479',
  './nm-folder-mockup.png?v=5479',
  './nm-scale-mockup.png?v=5479',
  './nm-doc-mockup.png?v=5479',
