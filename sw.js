const CACHE = 'advokat-iphone-offline-v121-premium-5455';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5455',
  './bg-new-matter-approved.webp?v=5455',
  './nm-folder-mockup.png?v=5455',
  './nm-scale-mockup.png?v=5455',
  './nm-doc-mockup.png?v=5455',
