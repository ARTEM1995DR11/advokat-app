const CACHE = 'advokat-iphone-offline-v121-premium-5483';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5483',
  './new-matter-client.css?v=5483',
  './new-matter-stage.css?v=5483',
  './new-matter-values.css?v=5483',
  './new-matter-save.css?v=5483',
  './app.js?v=5483',
  './manifest.webmanifest?v=5483',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5483',
  ...
  './header-filter-premium.png?v=5483',
  './bg-new-matter-approved.webp?v=5483',
  './nm-folder-mockup.png?v=5483',
  './nm-scale-mockup.png?v=5483',
  './nm-doc-mockup.png?v=5483',
