const CACHE = 'advokat-iphone-offline-v40-stable-5064';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5064',
  './nav-panel-light.png',
  './nav-active-base.png?v=5064',
  './nav-active-today.png?v=5064',
  './nav-active-tasks.png?v=5064',
  './nav-active-cases.png?v=5064',
  './nav-active-calendar.png?v=5064',
  './nav-active-more.png?v=5064',
  './app.js?v=5064',
  './manifest.webmanifest?v=5064',
