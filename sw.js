const CACHE = 'advokat-iphone-offline-v121-premium-5469';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5469',
  './new-matter-client.css?v=5469',
  './new-matter-stage.css?v=5469',
  './app.js?v=5469',
  './manifest.webmanifest?v=5469',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5469',
  './bg-new-matter-approved.webp?v=5469',
  './nm-folder-mockup.png?v=5469',
  './nm-scale-mockup.png?v=5469',
  './nm-doc-mockup.png?v=5469',
