const CACHE = 'advokat-iphone-offline-v40-stable-5054';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5054',
  ...
  './nav-active-today-5054.png',
  './nav-active-tasks-5054.png',
  './nav-active-calendar-5054.png',
  './nav-active-more-5054.png',
  './app.js?v=5054',
  './manifest.webmanifest?v=5054',
