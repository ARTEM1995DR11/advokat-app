const CACHE = 'advokat-iphone-offline-v121-premium-5462';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5462',
  './bg-new-matter-approved.webp?v=5462',
  './nm-folder-mockup.png?v=5462',
  './nm-scale-mockup.png?v=5462',
  './nm-doc-mockup.png?v=5462',
