const CACHE = 'advokat-iphone-offline-v121-premium-5498';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5498',
  './cases-folders.css?v=5498',
  './new-matter-client.css?v=5498',
  './new-matter-stage.css?v=5498',
  './new-matter-values.css?v=5498',
  './new-matter-save.css?v=5498',
  './app.js?v=5498',
  './manifest.webmanifest?v=5498',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5498',
  ...
  './header-filter-premium.png?v=5498',
  './bg-new-matter-approved.webp?v=5498',
  './nm-folder-mockup.png?v=5498',
  './nm-scale-mockup.png?v=5498',
  './nm-doc-mockup.png?v=5498',
