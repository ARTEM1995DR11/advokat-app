const CACHE = 'advokat-iphone-offline-v121-premium-5422';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5422',
  './bg-new-matter-approved.webp?v=5422',
  './nm-folder-mockup.png?v=5422',
  './nm-scale-mockup.png?v=5422',
  './nm-doc-mockup.png?v=5422',
