const CACHE = 'advokat-iphone-offline-v40-stable-5142';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5142',
  './nav-panel-light.png',
  './nav-active-base.png?v=5142',
  './nav-active-today.png?v=5142',
  './nav-active-tasks.png?v=5142',
  './nav-active-cases.png?v=5142',
  './nav-active-calendar.png?v=5142',
  './nav-active-more.png?v=5142',
  './app.js?v=5142',
  './manifest.webmanifest?v=5142',
  ...
  './header-bell-premium.png?v=5142',
  './header-search-premium.png?v=5142',
  './quick-sheet-marble-approved.png?v=5142',
  './search-medallion.png?v=5142',
  './quick-icon-hearing.png?v=5142',
  './quick-icon-meeting.png?v=5142',
  './quick-icon-deadline.png?v=5142',
  './quick-icon-task.png?v=5142',
  './quick-icon-journal.png?v=5142',
  './reminder-head-motif-exact.png?v=5142',
  './reminder-footer-scales-exact.png?v=5142',
  './VERSION.txt'
];
