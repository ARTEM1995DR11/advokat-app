const CACHE = 'advokat-iphone-offline-v40-stable-5147';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5147',
  './nav-panel-light.png',
  './nav-active-base.png?v=5147',
  './nav-active-today.png?v=5147',
  './nav-active-tasks.png?v=5147',
  './nav-active-cases.png?v=5147',
  './nav-active-calendar.png?v=5147',
  './nav-active-more.png?v=5147',
  './app.js?v=5147',
  './manifest.webmanifest?v=5147',
  ...
  './header-bell-premium.png?v=5147',
  './header-search-premium.png?v=5147',
  './quick-sheet-marble-approved.png?v=5147',
  './quick-icon-hearing.png?v=5147',
  './quick-icon-meeting.png?v=5147',
  './quick-icon-deadline.png?v=5147',
  './quick-icon-task.png?v=5147',
  './quick-icon-journal.png?v=5147',
  './search-medallion.png?v=5147',
  './reminder-head-motif-exact.png?v=5147',
  './reminder-footer-scales-exact.png?v=5147',
  './VERSION.txt'
];
