const CACHE = 'advokat-iphone-offline-v122-premium-5524';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5524',
  './cases-folders.css?v=5524',
  './new-matter-client.css?v=5524',
  './new-matter-stage.css?v=5524',
  './new-matter-values.css?v=5524',
  './new-matter-save.css?v=5524',
  './app.js?v=5524',
  './manifest.webmanifest?v=5524',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5524',
  ...
  './header-filter-premium.png?v=5524',
  './bg-new-matter-approved.webp?v=5524',
  './nm-folder-mockup.png?v=5524',
  './nm-scale-mockup.png?v=5524',
  './nm-doc-mockup.png?v=5524',
