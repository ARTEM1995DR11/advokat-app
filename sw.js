const CACHE = 'advokat-iphone-offline-v121-premium-5449';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5449',
  './bg-new-matter-approved.webp?v=5449',
  './nm-folder-mockup.png?v=5449',
  './nm-scale-mockup.png?v=5449',
  './nm-doc-mockup.png?v=5449',
