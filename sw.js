const CACHE = 'advokat-iphone-offline-v122-premium-5535';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5535',
  './cases-folders.css?v=5535',
  './new-matter-client.css?v=5535',
  './new-matter-stage.css?v=5535',
  './new-matter-values.css?v=5535',
  './new-matter-save.css?v=5535',
  './app.js?v=5535',
  './manifest.webmanifest?v=5535',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5535',
  ...
  './header-filter-premium.png?v=5535',
  './bg-new-matter-approved.webp?v=5535',
  './nm-folder-mockup.png?v=5535',
  './nm-scale-mockup.png?v=5535',
  './nm-doc-mockup.png?v=5535',
