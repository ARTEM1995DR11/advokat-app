const CACHE = 'advokat-iphone-offline-v55-premium-5225';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5225',
  './app.js?v=5225',
  './manifest.webmanifest?v=5225',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5225',
  './quick-sheet-marble-approved.webp?v=5225',
  './quick-sheet-mobile-approved-v5211.webp?v=5225',
  './columns-light.png?v=5225',
  './header-bell-premium.png?v=5225',
  './header-search-premium.png?v=5225',
  './global-search-head-motif-v173.png?v=5225',
  './nav-panel-light.png',
  './nav-active-base.png?v=5225',
  './nav-active-today.png?v=5225',
  './fab-plus-square-premium.png?v=5225',
  './VERSION.txt'
];
