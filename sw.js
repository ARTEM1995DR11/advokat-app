const CACHE = 'advokat-iphone-offline-v121-premium-5495';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5495',
  './cases-folders.css?v=5495',
  './new-matter-client.css?v=5495',
  './new-matter-stage.css?v=5495',
  './new-matter-values.css?v=5495',
  './new-matter-save.css?v=5495',
  './app.js?v=5495',
  './manifest.webmanifest?v=5495',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5495',
  ...
  './header-filter-premium.png?v=5495',
  './bg-new-matter-approved.webp?v=5495',
  './nm-folder-mockup.png?v=5495',
  './nm-scale-mockup.png?v=5495',
  './nm-doc-mockup.png?v=5495',
