const CACHE = 'advokat-iphone-offline-v122-premium-5525';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5525',
  './cases-folders.css?v=5525',
  './new-matter-client.css?v=5525',
  './new-matter-stage.css?v=5525',
  './new-matter-values.css?v=5525',
  './new-matter-save.css?v=5525',
  './app.js?v=5525',
  './manifest.webmanifest?v=5525',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5525',
  ...
  './header-filter-premium.png?v=5525',
  './bg-new-matter-approved.webp?v=5525',
  './nm-folder-mockup.png?v=5525',
  './nm-scale-mockup.png?v=5525',
  './nm-doc-mockup.png?v=5525',
