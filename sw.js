const CACHE = 'advokat-iphone-offline-v121-premium-5375';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5375',
...
self.addEventListener('fetch', event => {
  ...
  /* 5.0.375 — on an online launch prefer the freshly deployed shell.
