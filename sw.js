const CACHE = 'advokat-iphone-offline-v121-premium-5461';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5461',
  './bg-new-matter-approved.webp?v=5461',
  './nm-folder-mockup.png?v=5461',
  './nm-scale-mockup.png?v=5461',
  './nm-doc-mockup.png?v=5461',
