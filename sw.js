const CACHE = 'advokat-iphone-offline-v121-premium-5504';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5504',
  './cases-folders.css?v=5504',
  './new-matter-client.css?v=5504',
  './new-matter-stage.css?v=5504',
  './new-matter-values.css?v=5504',
  './new-matter-save.css?v=5504',
  './app.js?v=5504',
  './manifest.webmanifest?v=5504',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5504',
  ...
  './header-filter-premium.png?v=5504',
  './bg-new-matter-approved.webp?v=5504',
  './nm-folder-mockup.png?v=5504',
  './nm-scale-mockup.png?v=5504',
  './nm-doc-mockup.png?v=5504',
