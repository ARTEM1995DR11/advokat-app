const CACHE = 'advokat-iphone-offline-v121-premium-5478';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5478',
  './new-matter-client.css?v=5478',
  './new-matter-stage.css?v=5478',
  './new-matter-values.css?v=5478',
  './new-matter-save.css?v=5478',
  './app.js?v=5478',
  './manifest.webmanifest?v=5478',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5478',
  './bg-new-matter-approved.webp?v=5478',
  './nm-folder-mockup.png?v=5478',
  './nm-scale-mockup.png?v=5478',
  './nm-doc-mockup.png?v=5478',
