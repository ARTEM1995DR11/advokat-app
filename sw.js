const CACHE = 'advokat-iphone-offline-v121-premium-5492';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5492',
  './cases-folders.css?v=5492',
  './new-matter-client.css?v=5492',
  './new-matter-stage.css?v=5492',
  './new-matter-values.css?v=5492',
  './new-matter-save.css?v=5492',
  './app.js?v=5492',
  './manifest.webmanifest?v=5492',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5492',
  ...
  './header-filter-premium.png?v=5492',
  './bg-new-matter-approved.webp?v=5492',
  './nm-folder-mockup.png?v=5492',
  './nm-scale-mockup.png?v=5492',
  './nm-doc-mockup.png?v=5492',
