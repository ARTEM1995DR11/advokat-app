const CACHE = 'advokat-iphone-offline-v40-stable-5148';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5148',
  './nav-panel-light.png',
  './nav-active-base.png?v=5148',
  './nav-active-today.png?v=5148',
  './nav-active-tasks.png?v=5148',
  './nav-active-cases.png?v=5148',
  './nav-active-calendar.png?v=5148',
  './nav-active-more.png?v=5148',
  './app.js?v=5148',
  './manifest.webmanifest?v=5148',
  ...
  './header-bell-premium.png?v=5148',
  './header-search-premium.png?v=5148',
  './quick-sheet-marble-approved.png?v=5148',
  './quick-icon-hearing.png?v=5148',
  './quick-icon-meeting.png?v=5148',
  './quick-icon-deadline.png?v=5148',
  './quick-icon-task.png?v=5148',
  './quick-icon-journal.png?v=5148',
  './search-medallion.png?v=5148',
  './reminder-head-motif-exact.png?v=5148',
  './reminder-footer-scales-exact.png?v=5148',
  './VERSION.txt'
];
