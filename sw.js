const CACHE = 'advokat-iphone-offline-v121-premium-5452';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5452',
  './bg-new-matter-approved.webp?v=5452',
  './nm-folder-mockup.png?v=5452',
  './nm-scale-mockup.png?v=5452',
  './nm-doc-mockup.png?v=5452',
