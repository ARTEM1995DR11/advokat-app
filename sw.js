const CACHE = 'advokat-iphone-offline-v121-premium-5489';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5489',
  './cases-folders.css?v=5489',
  './new-matter-client.css?v=5489',
  './new-matter-stage.css?v=5489',
  './new-matter-values.css?v=5489',
  './new-matter-save.css?v=5489',
  './app.js?v=5489',
  './manifest.webmanifest?v=5489',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5489',
  ...
  './header-filter-premium.png?v=5489',
  './bg-new-matter-approved.webp?v=5489',
  './nm-folder-mockup.png?v=5489',
  './nm-scale-mockup.png?v=5489',
  './nm-doc-mockup.png?v=5489',
