const CACHE = 'advokat-iphone-offline-v121-premium-5468';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5468',
  './new-matter-client.css?v=5468',
  './app.js?v=5468',
  './manifest.webmanifest?v=5468',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5468',
  './bg-new-matter-approved.webp?v=5468',
  './nm-folder-mockup.png?v=5468',
  './nm-scale-mockup.png?v=5468',
  './nm-doc-mockup.png?v=5468',
