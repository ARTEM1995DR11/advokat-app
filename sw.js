const CACHE = 'advokat-iphone-offline-v40-stable-5057';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5057',
  './nav-panel-light.png',
  './nav-panel-dark.png',
  './nav-active-base.png?v=5057',
  './nav-active-today.png?v=5057',
  './nav-active-tasks.png?v=5057',
  './nav-active-cases.png?v=5057',
  './nav-active-calendar.png?v=5057',
  './nav-active-more.png?v=5057',
  './app.js?v=5057',
  './manifest.webmanifest?v=5057',
