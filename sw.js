const CACHE = 'advokat-iphone-offline-v126-premium-5542';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5542',
  './cases-folders.css?v=5542',
  './new-matter-client.css?v=5542',
  './new-matter-stage.css?v=5542',
  './new-matter-values.css?v=5542',
  './new-matter-save.css?v=5542',
  './app.js?v=5542',
  './manifest.webmanifest?v=5542',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5542',
  ...
  './header-filter-premium.png?v=5542',
  './bg-new-matter-approved.webp?v=5542',
  './nm-folder-mockup.png?v=5542',
  './nm-scale-mockup.png?v=5542',
  './nm-doc-mockup.png?v=5542',
