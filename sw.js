const CACHE = 'advokat-iphone-offline-v121-premium-5486';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5486',
  './cases-folders.css?v=5486',
  './new-matter-client.css?v=5486',
  './new-matter-stage.css?v=5486',
  './new-matter-values.css?v=5486',
  './new-matter-save.css?v=5486',
  './app.js?v=5486',
  './manifest.webmanifest?v=5486',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5486',
  ...
  './header-filter-premium.png?v=5486',
  './bg-new-matter-approved.webp?v=5486',
  './nm-folder-mockup.png?v=5486',
  './nm-scale-mockup.png?v=5486',
  './nm-doc-mockup.png?v=5486',
