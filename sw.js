const CACHE = 'advokat-iphone-offline-v121-premium-5481';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5481',
  './new-matter-client.css?v=5481',
  './new-matter-stage.css?v=5481',
  './new-matter-values.css?v=5481',
  './new-matter-save.css?v=5481',
  './app.js?v=5481',
  './manifest.webmanifest?v=5481',
  './VERSION.txt',
  ...
  './matter-save-gold-v5480.png?v=5481',
  ...
  './header-filter-premium.png?v=5481',
  './bg-new-matter-approved.webp?v=5481',
  './nm-folder-mockup.png?v=5481',
  './nm-scale-mockup.png?v=5481',
  './nm-doc-mockup.png?v=5481',
