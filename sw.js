const CACHE = 'advokat-iphone-offline-v121-premium-5474';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5474',
  './new-matter-client.css?v=5474',
  './new-matter-stage.css?v=5474',
  './app.js?v=5474',
  './manifest.webmanifest?v=5474',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5474',
  './bg-new-matter-approved.webp?v=5474',
  './nm-folder-mockup.png?v=5474',
  './nm-scale-mockup.png?v=5474',
  './nm-doc-mockup.png?v=5474',
