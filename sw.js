const CACHE = 'advokat-iphone-offline-v121-premium-5436';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5436',
  './bg-new-matter-approved.webp?v=5436',
  './nm-folder-mockup.png?v=5436',
  './nm-scale-mockup.png?v=5436',
  './nm-doc-mockup.png?v=5436',
