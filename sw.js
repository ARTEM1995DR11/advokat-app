const CACHE = 'advokat-iphone-offline-v121-premium-5487';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5487',
  './cases-folders.css?v=5487',
  './new-matter-client.css?v=5487',
  './new-matter-stage.css?v=5487',
  './new-matter-values.css?v=5487',
  './new-matter-save.css?v=5487',
  './app.js?v=5487',
  './manifest.webmanifest?v=5487',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5487',
  ...
  './header-filter-premium.png?v=5487',
  './bg-new-matter-approved.webp?v=5487',
  './nm-folder-mockup.png?v=5487',
  './nm-scale-mockup.png?v=5487',
  './nm-doc-mockup.png?v=5487',
