const CACHE = 'advokat-iphone-offline-v121-premium-5501';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5501',
  './cases-folders.css?v=5501',
  './new-matter-client.css?v=5501',
  './new-matter-stage.css?v=5501',
  './new-matter-values.css?v=5501',
  './new-matter-save.css?v=5501',
  './app.js?v=5501',
  './manifest.webmanifest?v=5501',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5501',
  ...
  './header-filter-premium.png?v=5501',
  './bg-new-matter-approved.webp?v=5501',
  './nm-folder-mockup.png?v=5501',
  './nm-scale-mockup.png?v=5501',
  './nm-doc-mockup.png?v=5501',
