const CACHE = 'advokat-iphone-offline-v40-stable-5101';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5101',
  './nav-panel-light.png',
  './nav-active-base.png?v=5101',
  './nav-active-today.png?v=5101',
  './nav-active-tasks.png?v=5101',
  './nav-active-cases.png?v=5101',
  './nav-active-calendar.png?v=5101',
  './nav-active-more.png?v=5101',
  './app.js?v=5101',
  './manifest.webmanifest?v=5101',
  ...
  './header-bell-premium.png?v=5101',
  './header-search-premium.png?v=5101',
  './quick-sheet-marble-approved.png?v=5101',
  './quick-icon-hearing.png?v=5101',
  './quick-icon-meeting.png?v=5101',
  './quick-icon-deadline.png?v=5101',
  './quick-icon-task.png?v=5101',
  './quick-icon-journal.png?v=5101',
  './VERSION.txt'
];
