const CACHE = 'advokat-iphone-offline-v121-premium-5508';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5508',
  './cases-folders.css?v=5508',
  './new-matter-client.css?v=5508',
  './new-matter-stage.css?v=5508',
  './new-matter-values.css?v=5508',
  './new-matter-save.css?v=5508',
  './app.js?v=5508',
  './manifest.webmanifest?v=5508',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5508',
  ...
  './header-filter-premium.png?v=5508',
  './bg-new-matter-approved.webp?v=5508',
  './nm-folder-mockup.png?v=5508',
  './nm-scale-mockup.png?v=5508',
  './nm-doc-mockup.png?v=5508',
