const CACHE = 'advokat-iphone-offline-v40-stable-5143';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5143',
  './nav-panel-light.png',
  './nav-active-base.png?v=5143',
  './nav-active-today.png?v=5143',
  './nav-active-tasks.png?v=5143',
  './nav-active-cases.png?v=5143',
  './nav-active-calendar.png?v=5143',
  './nav-active-more.png?v=5143',
  './app.js?v=5143',
  './manifest.webmanifest?v=5143',
  ...
  './header-bell-premium.png?v=5143',
  './header-search-premium.png?v=5143',
  './quick-sheet-marble-approved.png?v=5143',
  './search-medallion.png?v=5143',
  './reminder-head-motif-exact.png?v=5143',
  './reminder-footer-scales-exact.png?v=5143',
  './VERSION.txt'
];
