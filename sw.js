const CACHE = 'advokat-iphone-offline-v121-premium-5419';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5419',
  './bg-new-matter-approved.webp?v=5419',
  './nm-folder-mockup.png?v=5419',
  './nm-scale-mockup.png?v=5419',
  './nm-doc-mockup.png?v=5419',
