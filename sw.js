const CACHE = 'advokat-iphone-offline-v40-stable-5053';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5053',
  ...
  './nav-active-today-5053.png',
  './nav-active-tasks-5053.png',
  './nav-active-calendar-5053.png',
  './nav-active-more-5053.png',
  './app.js?v=5053',
  './manifest.webmanifest?v=5053',
