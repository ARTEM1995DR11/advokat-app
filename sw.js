const CACHE = 'advokat-iphone-offline-v40-stable-5103';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5103',
  './nav-panel-light.png',
  './nav-active-base.png?v=5103',
  './nav-active-today.png?v=5103',
  './nav-active-tasks.png?v=5103',
  './nav-active-cases.png?v=5103',
  './nav-active-calendar.png?v=5103',
  './nav-active-more.png?v=5103',
  './app.js?v=5103',
  './manifest.webmanifest?v=5103',
  ...
  './header-bell-premium.png?v=5103',
  './header-search-premium.png?v=5103',
  './quick-sheet-marble-approved.png?v=5103',
  './quick-icon-hearing.png?v=5103',
  './quick-icon-meeting.png?v=5103',
  './quick-icon-deadline.png?v=5103',
  './quick-icon-task.png?v=5103',
  './quick-icon-journal.png?v=5103',
  './VERSION.txt'
];
