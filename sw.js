const CACHE = 'advokat-iphone-offline-v40-stable-5105';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5105',
  './nav-panel-light.png',
  './nav-active-base.png?v=5105',
  './nav-active-today.png?v=5105',
  './nav-active-tasks.png?v=5105',
  './nav-active-cases.png?v=5105',
  './nav-active-calendar.png?v=5105',
  './nav-active-more.png?v=5105',
  './app.js?v=5105',
  './manifest.webmanifest?v=5105',
  ...
  './header-bell-premium.png?v=5105',
  './header-search-premium.png?v=5105',
  './quick-sheet-marble-approved.png?v=5105',
  './notify-sheet-ornament-approved.png?v=5105',
  './quick-icon-hearing.png?v=5105',
  './quick-icon-meeting.png?v=5105',
  './quick-icon-deadline.png?v=5105',
  './quick-icon-task.png?v=5105',
  './quick-icon-journal.png?v=5105',
  './VERSION.txt'
];
