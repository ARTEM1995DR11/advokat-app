const CACHE = 'advokat-iphone-offline-v40-stable-5065';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5065',
  './nav-panel-light.png',
  './nav-active-base.png?v=5065',
  './nav-active-today.png?v=5065',
  './nav-active-tasks.png?v=5065',
  './nav-active-cases.png?v=5065',
  './nav-active-calendar.png?v=5065',
  './nav-active-more.png?v=5065',
  './app.js?v=5065',
  './manifest.webmanifest?v=5065',
