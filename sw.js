const CACHE = 'advokat-iphone-offline-v54-premium-5224';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5224',
  './app.js?v=5224',
  './manifest.webmanifest?v=5224',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5224',
  './quick-sheet-marble-approved.webp?v=5224',
  './quick-sheet-mobile-approved-v5211.webp?v=5224',
  './columns-light.png?v=5224',
  './header-bell-premium.png?v=5224',
  './header-search-premium.png?v=5224',
  './global-search-head-motif-v173.png?v=5224',
  './nav-panel-light.png',
  './nav-active-base.png?v=5224',
  './nav-active-today.png?v=5224',
  './fab-plus-square-premium.png?v=5224',
  './VERSION.txt'
];
