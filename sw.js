const CACHE = 'advokat-iphone-offline-v121-premium-5476';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5476',
  './new-matter-client.css?v=5476',
  './new-matter-stage.css?v=5476',
  './new-matter-values.css?v=5476',
  './app.js?v=5476',
  './manifest.webmanifest?v=5476',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5476',
  './bg-new-matter-approved.webp?v=5476',
  './nm-folder-mockup.png?v=5476',
  './nm-scale-mockup.png?v=5476',
  './nm-doc-mockup.png?v=5476',
