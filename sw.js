const CACHE = 'advokat-iphone-offline-v44-premium-5193';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5193',
  './app.js?v=5193',
  './manifest.webmanifest?v=5193',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5193',
  './quick-sheet-marble-approved.webp?v=5193',
  './columns-light.png?v=5193',
  './header-bell-premium.png?v=5193',
  './header-search-premium.png?v=5193',
  './global-search-head-motif-v173.png?v=5193',
  './nav-panel-light.png',
  './nav-active-base.png?v=5193',
  './nav-active-today.png?v=5193',
  './fab-plus-square-premium.png?v=5193',
  './VERSION.txt'
];
