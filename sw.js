const CACHE = 'advokat-iphone-offline-v121-premium-5430';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5430',
  './bg-new-matter-approved.webp?v=5430',
  './nm-folder-mockup.png?v=5430',
  './nm-scale-mockup.png?v=5430',
  './nm-doc-mockup.png?v=5430',
