const CACHE = 'advokat-iphone-offline-v122-premium-5533';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5533',
  './cases-folders.css?v=5533',
  './new-matter-client.css?v=5533',
  './new-matter-stage.css?v=5533',
  './new-matter-values.css?v=5533',
  './new-matter-save.css?v=5533',
  './app.js?v=5533',
  './manifest.webmanifest?v=5533',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5533',
  ...
  './header-filter-premium.png?v=5533',
  './bg-new-matter-approved.webp?v=5533',
  './nm-folder-mockup.png?v=5533',
  './nm-scale-mockup.png?v=5533',
  './nm-doc-mockup.png?v=5533',
