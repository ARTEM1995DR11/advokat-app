const CACHE = 'advokat-iphone-offline-v122-premium-5526';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5526',
  './cases-folders.css?v=5526',
  './new-matter-client.css?v=5526',
  './new-matter-stage.css?v=5526',
  './new-matter-values.css?v=5526',
  './new-matter-save.css?v=5526',
  './app.js?v=5526',
  './manifest.webmanifest?v=5526',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5526',
  ...
  './header-filter-premium.png?v=5526',
  './bg-new-matter-approved.webp?v=5526',
  './nm-folder-mockup.png?v=5526',
  './nm-scale-mockup.png?v=5526',
  './nm-doc-mockup.png?v=5526',
