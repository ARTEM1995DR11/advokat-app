const CACHE = 'advokat-iphone-offline-v40-stable-5150';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5150',
  './nav-panel-light.png',
  './nav-active-base.png?v=5150',
  './nav-active-today.png?v=5150',
  './nav-active-tasks.png?v=5150',
  './nav-active-cases.png?v=5150',
  './nav-active-calendar.png?v=5150',
  './nav-active-more.png?v=5150',
  './app.js?v=5150',
  './manifest.webmanifest?v=5150',
  ...
  './header-bell-premium.png?v=5150',
  './header-search-premium.png?v=5150',
  './quick-sheet-marble-approved.png?v=5150',
  './quick-icon-hearing.png?v=5150',
  './quick-icon-meeting.png?v=5150',
  './quick-icon-deadline.png?v=5150',
  './quick-icon-task.png?v=5150',
  './quick-icon-journal.png?v=5150',
  './search-medallion.png?v=5150',
  './reminder-head-motif-exact.png?v=5150',
  './reminder-footer-scales-exact.png?v=5150',
  './VERSION.txt'
];
