const CACHE = 'advokat-iphone-offline-v121-premium-5493';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5493',
  './cases-folders.css?v=5493',
  './new-matter-client.css?v=5493',
  './new-matter-stage.css?v=5493',
  './new-matter-values.css?v=5493',
  './new-matter-save.css?v=5493',
  './app.js?v=5493',
  './manifest.webmanifest?v=5493',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5493',
  ...
  './header-filter-premium.png?v=5493',
  './bg-new-matter-approved.webp?v=5493',
  './nm-folder-mockup.png?v=5493',
  './nm-scale-mockup.png?v=5493',
  './nm-doc-mockup.png?v=5493',
