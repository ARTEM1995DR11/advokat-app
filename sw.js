const CACHE = 'advokat-iphone-offline-v121-premium-5473';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5473',
  './new-matter-client.css?v=5473',
  './new-matter-stage.css?v=5473',
  './app.js?v=5473',
  './manifest.webmanifest?v=5473',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5473',
  './bg-new-matter-approved.webp?v=5473',
  './nm-folder-mockup.png?v=5473',
  './nm-scale-mockup.png?v=5473',
  './nm-doc-mockup.png?v=5473',
