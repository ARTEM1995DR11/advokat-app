const CACHE = 'advokat-iphone-offline-v121-premium-5509';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5509',
  './cases-folders.css?v=5509',
  './new-matter-client.css?v=5509',
  './new-matter-stage.css?v=5509',
  './new-matter-values.css?v=5509',
  './new-matter-save.css?v=5509',
  './app.js?v=5509',
  './manifest.webmanifest?v=5509',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5509',
  ...
  './header-filter-premium.png?v=5509',
  './bg-new-matter-approved.webp?v=5509',
  './nm-folder-mockup.png?v=5509',
  './nm-scale-mockup.png?v=5509',
  './nm-doc-mockup.png?v=5509',
