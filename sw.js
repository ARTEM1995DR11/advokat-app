const CACHE = 'advokat-iphone-offline-v121-premium-5439';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5439',
  './bg-new-matter-approved.webp?v=5439',
  './nm-folder-mockup.png?v=5439',
  './nm-scale-mockup.png?v=5439',
  './nm-doc-mockup.png?v=5439',
