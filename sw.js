const CACHE = 'advokat-iphone-offline-v49-premium-5219';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5219',
  './app.js?v=5219',
  './manifest.webmanifest?v=5219',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5219',
  './quick-sheet-marble-approved.webp?v=5219',
  './quick-sheet-mobile-approved-v5211.webp?v=5219',
  './columns-light.png?v=5219',
  './header-bell-premium.png?v=5219',
  './header-search-premium.png?v=5219',
  './global-search-head-motif-v173.png?v=5219',
  './nav-panel-light.png',
  './nav-active-base.png?v=5219',
  './nav-active-today.png?v=5219',
  './fab-plus-square-premium.png?v=5219',
  './VERSION.txt'
];
