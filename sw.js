const CACHE = 'advokat-iphone-offline-v40-stable-5149';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5149',
  './nav-panel-light.png',
  './nav-active-base.png?v=5149',
  './nav-active-today.png?v=5149',
  './nav-active-tasks.png?v=5149',
  './nav-active-cases.png?v=5149',
  './nav-active-calendar.png?v=5149',
  './nav-active-more.png?v=5149',
  './app.js?v=5149',
  './manifest.webmanifest?v=5149',
  ...
  './header-bell-premium.png?v=5149',
  './header-search-premium.png?v=5149',
  './quick-sheet-marble-approved.png?v=5149',
  './quick-icon-hearing.png?v=5149',
  './quick-icon-meeting.png?v=5149',
  './quick-icon-deadline.png?v=5149',
  './quick-icon-task.png?v=5149',
  './quick-icon-journal.png?v=5149',
  './search-medallion.png?v=5149',
  './reminder-head-motif-exact.png?v=5149',
  './reminder-footer-scales-exact.png?v=5149',
  './VERSION.txt'
];
