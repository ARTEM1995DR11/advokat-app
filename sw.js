const CACHE = 'advokat-iphone-offline-v121-premium-5467';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5467',
  './new-matter-client.css?v=5467',
  './app.js?v=5467',
  './manifest.webmanifest?v=5467',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5467',
  './bg-new-matter-approved.webp?v=5467',
  './nm-folder-mockup.png?v=5467',
  './nm-scale-mockup.png?v=5467',
  './nm-doc-mockup.png?v=5467',
