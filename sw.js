const CACHE = 'advokat-iphone-offline-v122-premium-5523';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5523',
  './cases-folders.css?v=5523',
  './new-matter-client.css?v=5523',
  './new-matter-stage.css?v=5523',
  './new-matter-values.css?v=5523',
  './new-matter-save.css?v=5523',
  './app.js?v=5523',
  './manifest.webmanifest?v=5523',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5523',
  ...
  './header-filter-premium.png?v=5523',
  './bg-new-matter-approved.webp?v=5523',
  './nm-folder-mockup.png?v=5523',
  './nm-scale-mockup.png?v=5523',
  './nm-doc-mockup.png?v=5523',
