const CACHE = 'advokat-iphone-offline-v123-premium-5536';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5536',
  './cases-folders.css?v=5536',
  './new-matter-client.css?v=5536',
  './new-matter-stage.css?v=5536',
  './new-matter-values.css?v=5536',
  './new-matter-save.css?v=5536',
  './app.js?v=5536',
  './manifest.webmanifest?v=5536',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5536',
  ...
  './header-filter-premium.png?v=5536',
  './bg-new-matter-approved.webp?v=5536',
  './nm-folder-mockup.png?v=5536',
  './nm-scale-mockup.png?v=5536',
  './nm-doc-mockup.png?v=5536',
