const CACHE = 'advokat-iphone-offline-v121-premium-5499';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5499',
  './cases-folders.css?v=5499',
  './new-matter-client.css?v=5499',
  './new-matter-stage.css?v=5499',
  './new-matter-values.css?v=5499',
  './new-matter-save.css?v=5499',
  './app.js?v=5499',
  './manifest.webmanifest?v=5499',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5499',
  ...
  './header-filter-premium.png?v=5499',
  './bg-new-matter-approved.webp?v=5499',
  './nm-folder-mockup.png?v=5499',
  './nm-scale-mockup.png?v=5499',
  './nm-doc-mockup.png?v=5499',
