const CACHE = 'advokat-iphone-offline-v121-premium-5470';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5470',
  './new-matter-client.css?v=5470',
  './new-matter-stage.css?v=5470',
  './app.js?v=5470',
  './manifest.webmanifest?v=5470',
  './VERSION.txt',
  ...
  './header-filter-premium.png?v=5470',
  './bg-new-matter-approved.webp?v=5470',
  './nm-folder-mockup.png?v=5470',
  './nm-scale-mockup.png?v=5470',
  './nm-doc-mockup.png?v=5470',
