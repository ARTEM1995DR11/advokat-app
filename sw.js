const CACHE = 'advokat-iphone-offline-v122-premium-5534';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5534',
  './cases-folders.css?v=5534',
  './new-matter-client.css?v=5534',
  './new-matter-stage.css?v=5534',
  './new-matter-values.css?v=5534',
  './new-matter-save.css?v=5534',
  './app.js?v=5534',
  './manifest.webmanifest?v=5534',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5534',
  ...
  './header-filter-premium.png?v=5534',
  './bg-new-matter-approved.webp?v=5534',
  './nm-folder-mockup.png?v=5534',
  './nm-scale-mockup.png?v=5534',
  './nm-doc-mockup.png?v=5534',
