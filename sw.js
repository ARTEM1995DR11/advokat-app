const CACHE = 'advokat-iphone-offline-v121-premium-5519';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5519',
  './cases-folders.css?v=5519',
  './new-matter-client.css?v=5519',
  './new-matter-stage.css?v=5519',
  './new-matter-values.css?v=5519',
  './new-matter-save.css?v=5519',
  './app.js?v=5519',
  './manifest.webmanifest?v=5519',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5519',
  ...
  './header-filter-premium.png?v=5519',
  './bg-new-matter-approved.webp?v=5519',
  './nm-folder-mockup.png?v=5519',
  './nm-scale-mockup.png?v=5519',
  './nm-doc-mockup.png?v=5519',
