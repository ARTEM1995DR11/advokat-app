const CACHE = 'advokat-iphone-offline-v121-premium-5496';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5496',
  './cases-folders.css?v=5496',
  './new-matter-client.css?v=5496',
  './new-matter-stage.css?v=5496',
  './new-matter-values.css?v=5496',
  './new-matter-save.css?v=5496',
  './app.js?v=5496',
  './manifest.webmanifest?v=5496',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5496',
  ...
  './header-filter-premium.png?v=5496',
  './bg-new-matter-approved.webp?v=5496',
  './nm-folder-mockup.png?v=5496',
  './nm-scale-mockup.png?v=5496',
  './nm-doc-mockup.png?v=5496',
