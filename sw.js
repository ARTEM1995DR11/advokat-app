const CACHE = 'advokat-iphone-offline-v40-stable-5104';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5104',
  './nav-panel-light.png',
  './nav-active-base.png?v=5104',
  './nav-active-today.png?v=5104',
  './nav-active-tasks.png?v=5104',
  './nav-active-cases.png?v=5104',
  './nav-active-calendar.png?v=5104',
  './nav-active-more.png?v=5104',
  './app.js?v=5104',
  './manifest.webmanifest?v=5104',
  ...
  './header-bell-premium.png?v=5104',
  './header-search-premium.png?v=5104',
  './quick-sheet-marble-approved.png?v=5104',
  './quick-icon-hearing.png?v=5104',
  './quick-icon-meeting.png?v=5104',
  './quick-icon-deadline.png?v=5104',
  './quick-icon-task.png?v=5104',
  './quick-icon-journal.png?v=5104',
  './VERSION.txt'
];
