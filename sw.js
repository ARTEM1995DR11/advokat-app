const CACHE = 'advokat-iphone-offline-v121-premium-5517';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5517',
  './cases-folders.css?v=5517',
  './new-matter-client.css?v=5517',
  './new-matter-stage.css?v=5517',
  './new-matter-values.css?v=5517',
  './new-matter-save.css?v=5517',
  './app.js?v=5517',
  './manifest.webmanifest?v=5517',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5517',
  ...
  './header-filter-premium.png?v=5517',
  './bg-new-matter-approved.webp?v=5517',
  './nm-folder-mockup.png?v=5517',
  './nm-scale-mockup.png?v=5517',
  './nm-doc-mockup.png?v=5517',
