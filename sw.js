const CACHE = 'advokat-iphone-offline-v121-premium-5515';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5515',
  './cases-folders.css?v=5515',
  './new-matter-client.css?v=5515',
  './new-matter-stage.css?v=5515',
  './new-matter-values.css?v=5515',
  './new-matter-save.css?v=5515',
  './app.js?v=5515',
  './manifest.webmanifest?v=5515',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5515',
  ...
  './header-filter-premium.png?v=5515',
  './bg-new-matter-approved.webp?v=5515',
  './nm-folder-mockup.png?v=5515',
  './nm-scale-mockup.png?v=5515',
  './nm-doc-mockup.png?v=5515',
