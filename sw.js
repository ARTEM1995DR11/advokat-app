const CACHE = 'advokat-iphone-offline-v129-premium-5545';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5545',
  './cases-folders.css?v=5545',
  './new-matter-client.css?v=5545',
  './new-matter-stage.css?v=5545',
  './new-matter-values.css?v=5545',
  './new-matter-save.css?v=5545',
  './app.js?v=5545',
  './manifest.webmanifest?v=5545',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5545',
  ...
  './header-filter-premium.png?v=5545',
  './bg-new-matter-approved.webp?v=5545',
  './nm-folder-mockup.png?v=5545',
  './nm-scale-mockup.png?v=5545',
  './nm-doc-mockup.png?v=5545',
