const CACHE = 'advokat-iphone-offline-v121-premium-5514';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5514',
  './cases-folders.css?v=5514',
  './new-matter-client.css?v=5514',
  './new-matter-stage.css?v=5514',
  './new-matter-values.css?v=5514',
  './new-matter-save.css?v=5514',
  './app.js?v=5514',
  './manifest.webmanifest?v=5514',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5514',
  ...
  './header-filter-premium.png?v=5514',
  './bg-new-matter-approved.webp?v=5514',
  './nm-folder-mockup.png?v=5514',
  './nm-scale-mockup.png?v=5514',
  './nm-doc-mockup.png?v=5514',
