const CACHE = 'advokat-iphone-offline-v122-premium-5528';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5528',
  './cases-folders.css?v=5528',
  './new-matter-client.css?v=5528',
  './new-matter-stage.css?v=5528',
  './new-matter-values.css?v=5528',
  './new-matter-save.css?v=5528',
  './app.js?v=5528',
  './manifest.webmanifest?v=5528',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5528',
  ...
  './header-filter-premium.png?v=5528',
  './bg-new-matter-approved.webp?v=5528',
  './nm-folder-mockup.png?v=5528',
  './nm-scale-mockup.png?v=5528',
  './nm-doc-mockup.png?v=5528',
