const CACHE = 'advokat-iphone-offline-v128-premium-5544';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5544',
  './cases-folders.css?v=5544',
  './new-matter-client.css?v=5544',
  './new-matter-stage.css?v=5544',
  './new-matter-values.css?v=5544',
  './new-matter-save.css?v=5544',
  './app.js?v=5544',
  './manifest.webmanifest?v=5544',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5544',
  ...
  './header-filter-premium.png?v=5544',
  './bg-new-matter-approved.webp?v=5544',
  './nm-folder-mockup.png?v=5544',
  './nm-scale-mockup.png?v=5544',
  './nm-doc-mockup.png?v=5544',
