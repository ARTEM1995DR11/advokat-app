const CACHE = 'advokat-iphone-offline-v40-stable-5061';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5061',
  './nav-panel-light.png',
  './nav-active-base.png?v=5061',
  './nav-active-today.png?v=5061',
  './nav-active-tasks.png?v=5061',
  './nav-active-cases.png?v=5061',
  './nav-active-calendar.png?v=5061',
  './nav-active-more.png?v=5061',
  './app.js?v=5061',
  './manifest.webmanifest?v=5061',
