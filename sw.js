const CACHE = 'advokat-iphone-offline-v121-premium-5490';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5490',
  './cases-folders.css?v=5490',
  './new-matter-client.css?v=5490',
  './new-matter-stage.css?v=5490',
  './new-matter-values.css?v=5490',
  './new-matter-save.css?v=5490',
  './app.js?v=5490',
  './manifest.webmanifest?v=5490',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5490',
  ...
  './header-filter-premium.png?v=5490',
  './bg-new-matter-approved.webp?v=5490',
  './nm-folder-mockup.png?v=5490',
  './nm-scale-mockup.png?v=5490',
  './nm-doc-mockup.png?v=5490',
