const CACHE = 'advokat-iphone-offline-v121-premium-5480';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5480',
  './new-matter-client.css?v=5480',
  './new-matter-stage.css?v=5480',
  './new-matter-values.css?v=5480',
  './new-matter-save.css?v=5480',
  './app.js?v=5480',
  './manifest.webmanifest?v=5480',
  './VERSION.txt',
  ...
  './matter-save-gold-v5480.png?v=5480',
  ...
  './header-filter-premium.png?v=5480',
  './bg-new-matter-approved.webp?v=5480',
  './nm-folder-mockup.png?v=5480',
  './nm-scale-mockup.png?v=5480',
  './nm-doc-mockup.png?v=5480',
