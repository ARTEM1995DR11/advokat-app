const CACHE = 'advokat-iphone-offline-v44-premium-5207';
const CORE = [
  './',
  './index.html',
  './styles.css?v=5207',
  './app.js?v=5207',
  './manifest.webmanifest?v=5207',
  './premium-icon-180.png',
  './premium-icon-192.png',
  './premium-icon-512.png',
  './bg-today-desk.webp',
  './scale-gold.webp?v=5207',
  './quick-sheet-marble-approved.webp?v=5207',
  './quick-sheet-mobile-approved-v5207.webp?v=5207',
  './columns-light.png?v=5207',
  './header-bell-premium.png?v=5207',
  './header-search-premium.png?v=5207',
  './global-search-head-motif-v173.png?v=5207',
  './nav-panel-light.png',
  './nav-active-base.png?v=5207',
  './nav-active-today.png?v=5207',
  './fab-plus-square-premium.png?v=5207',
  './VERSION.txt'
];
