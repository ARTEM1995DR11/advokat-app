const CACHE = 'advokat-iphone-offline-v40-stable-5066';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5066',
  './nav-panel-light.png',
  './nav-active-base.png?v=5066',
  './nav-active-today.png?v=5066',
  './nav-active-tasks.png?v=5066',
  './nav-active-cases.png?v=5066',
  './nav-active-calendar.png?v=5066',
  './nav-active-more.png?v=5066',
  './app.js?v=5066',
  './manifest.webmanifest?v=5066',
