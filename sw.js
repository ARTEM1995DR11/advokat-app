const CACHE = 'advokat-iphone-offline-v121-premium-5428';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5428',
  './bg-new-matter-approved.webp?v=5428',
  './nm-folder-mockup.png?v=5428',
  './nm-scale-mockup.png?v=5428',
  './nm-doc-mockup.png?v=5428',
