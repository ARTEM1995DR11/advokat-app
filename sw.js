const CACHE = 'advokat-iphone-offline-v124-premium-5539';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5539',
  './cases-folders.css?v=5539',
  './new-matter-client.css?v=5539',
  './new-matter-stage.css?v=5539',
  './new-matter-values.css?v=5539',
  './new-matter-save.css?v=5539',
  './app.js?v=5539',
  './manifest.webmanifest?v=5539',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5539',
  ...
  './header-filter-premium.png?v=5539',
  './bg-new-matter-approved.webp?v=5539',
  './nm-folder-mockup.png?v=5539',
  './nm-scale-mockup.png?v=5539',
  './nm-doc-mockup.png?v=5539',
