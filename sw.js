const CACHE = 'advokat-iphone-offline-v122-premium-5522';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5522',
  './cases-folders.css?v=5522',
  './new-matter-client.css?v=5522',
  './new-matter-stage.css?v=5522',
  './new-matter-values.css?v=5522',
  './new-matter-save.css?v=5522',
  './app.js?v=5522',
  './manifest.webmanifest?v=5522',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5522',
  ...
  './header-filter-premium.png?v=5522',
  './bg-new-matter-approved.webp?v=5522',
  './nm-folder-mockup.png?v=5522',
  './nm-scale-mockup.png?v=5522',
  './nm-doc-mockup.png?v=5522',
