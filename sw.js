const CACHE = 'advokat-iphone-offline-v40-stable-5151';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5151',
  './nav-panel-light.png',
  './nav-active-base.png?v=5151',
  './nav-active-today.png?v=5151',
  './nav-active-tasks.png?v=5151',
  './nav-active-cases.png?v=5151',
  './nav-active-calendar.png?v=5151',
  './nav-active-more.png?v=5151',
  './app.js?v=5151',
  './manifest.webmanifest?v=5151',
  ...
  './header-bell-premium.png?v=5151',
  './header-search-premium.png?v=5151',
  './quick-sheet-marble-approved.png?v=5151',
  './quick-icon-hearing.png?v=5151',
  './quick-icon-meeting.png?v=5151',
  './quick-icon-deadline.png?v=5151',
  './quick-icon-task.png?v=5151',
  './quick-icon-journal.png?v=5151',
  './search-medallion.png?v=5151',
  './reminder-head-motif-exact.png?v=5151',
  './reminder-footer-scales-exact.png?v=5151',
  './VERSION.txt'
];
