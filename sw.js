const CACHE = 'advokat-iphone-offline-v121-premium-5506';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5506',
  './cases-folders.css?v=5506',
  './new-matter-client.css?v=5506',
  './new-matter-stage.css?v=5506',
  './new-matter-values.css?v=5506',
  './new-matter-save.css?v=5506',
  './app.js?v=5506',
  './manifest.webmanifest?v=5506',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5506',
  ...
  './header-filter-premium.png?v=5506',
  './bg-new-matter-approved.webp?v=5506',
  './nm-folder-mockup.png?v=5506',
  './nm-scale-mockup.png?v=5506',
  './nm-doc-mockup.png?v=5506',
