const CACHE = 'advokat-iphone-offline-v40-stable-5140';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5140',
  './nav-panel-light.png',
  './nav-active-base.png?v=5140',
  './nav-active-today.png?v=5140',
  './nav-active-tasks.png?v=5140',
  './nav-active-cases.png?v=5140',
  './nav-active-calendar.png?v=5140',
  './nav-active-more.png?v=5140',
  './app.js?v=5140',
  './manifest.webmanifest?v=5140',
  ...
  './header-bell-premium.png?v=5140',
  './header-search-premium.png?v=5140',
  './quick-sheet-marble-approved.png?v=5140',
  './search-medallion.png?v=5140',
  './reminder-head-motif-exact.png?v=5140',
  './reminder-footer-scales-exact.png?v=5140',
  './VERSION.txt'
];
