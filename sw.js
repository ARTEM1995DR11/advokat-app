const CACHE = 'advokat-iphone-offline-v121-premium-5445';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5445',
  './bg-new-matter-approved.webp?v=5445',
  './nm-folder-mockup.png?v=5445',
  './nm-scale-mockup.png?v=5445',
  './nm-doc-mockup.png?v=5445',
