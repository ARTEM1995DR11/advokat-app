const CACHE = 'advokat-iphone-offline-v121-premium-5500';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5500',
  './cases-folders.css?v=5500',
  './new-matter-client.css?v=5500',
  './new-matter-stage.css?v=5500',
  './new-matter-values.css?v=5500',
  './new-matter-save.css?v=5500',
  './app.js?v=5500',
  './manifest.webmanifest?v=5500',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5500',
  ...
  './header-filter-premium.png?v=5500',
  './bg-new-matter-approved.webp?v=5500',
  './nm-folder-mockup.png?v=5500',
  './nm-scale-mockup.png?v=5500',
  './nm-doc-mockup.png?v=5500',
