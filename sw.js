const CACHE = 'advokat-iphone-offline-v40-stable-5106';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5106',
  './nav-panel-light.png',
  './nav-active-base.png?v=5106',
  './nav-active-today.png?v=5106',
  './nav-active-tasks.png?v=5106',
  './nav-active-cases.png?v=5106',
  './nav-active-calendar.png?v=5106',
  './nav-active-more.png?v=5106',
  './app.js?v=5106',
  './manifest.webmanifest?v=5106',
  ...
  './header-bell-premium.png?v=5106',
  './header-search-premium.png?v=5106',
  './quick-sheet-marble-approved.png?v=5106',
  './notify-sheet-ornament-approved.png?v=5106',
  './quick-icon-hearing.png?v=5106',
  './quick-icon-meeting.png?v=5106',
  './quick-icon-deadline.png?v=5106',
  './quick-icon-task.png?v=5106',
  './quick-icon-journal.png?v=5106',
  './VERSION.txt'
];
