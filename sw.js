const CACHE = 'advokat-iphone-offline-v121-premium-5494';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5494',
  './cases-folders.css?v=5494',
  './new-matter-client.css?v=5494',
  './new-matter-stage.css?v=5494',
  './new-matter-values.css?v=5494',
  './new-matter-save.css?v=5494',
  './app.js?v=5494',
  './manifest.webmanifest?v=5494',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5494',
  ...
  './header-filter-premium.png?v=5494',
  './bg-new-matter-approved.webp?v=5494',
  './nm-folder-mockup.png?v=5494',
  './nm-scale-mockup.png?v=5494',
  './nm-doc-mockup.png?v=5494',
