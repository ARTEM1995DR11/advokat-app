const CACHE = 'advokat-iphone-offline-v121-premium-5432';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5432',
  './bg-new-matter-approved.webp?v=5432',
  './nm-folder-mockup.png?v=5432',
  './nm-scale-mockup.png?v=5432',
  './nm-doc-mockup.png?v=5432',
