const CACHE = 'advokat-iphone-offline-v121-premium-5384';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5384',
  './bg-new-matter-approved-v5384.webp?v=5384',
