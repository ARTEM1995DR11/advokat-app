const CACHE = 'advokat-iphone-offline-v130-premium-5546';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5546',
  './cases-folders.css?v=5546',
  './new-matter-client.css?v=5546',
  './new-matter-stage.css?v=5546',
  './new-matter-values.css?v=5546',
  './new-matter-save.css?v=5546',
  './app.js?v=5546',
  './manifest.webmanifest?v=5546',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5546',
  ...
  './header-filter-premium.png?v=5546',
  './bg-new-matter-approved.webp?v=5546',
  './nm-folder-mockup.png?v=5546',
  './nm-scale-mockup.png?v=5546',
  './nm-doc-mockup.png?v=5546',
