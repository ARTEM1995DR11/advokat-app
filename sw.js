const CACHE = 'advokat-iphone-offline-v122-premium-5527';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5527',
  './cases-folders.css?v=5527',
  './new-matter-client.css?v=5527',
  './new-matter-stage.css?v=5527',
  './new-matter-values.css?v=5527',
  './new-matter-save.css?v=5527',
  './app.js?v=5527',
  './manifest.webmanifest?v=5527',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5527',
  ...
  './header-filter-premium.png?v=5527',
  './bg-new-matter-approved.webp?v=5527',
  './nm-folder-mockup.png?v=5527',
  './nm-scale-mockup.png?v=5527',
  './nm-doc-mockup.png?v=5527',
