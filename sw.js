const CACHE = 'advokat-iphone-offline-v122-premium-5530';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5530',
  './cases-folders.css?v=5530',
  './new-matter-client.css?v=5530',
  './new-matter-stage.css?v=5530',
  './new-matter-values.css?v=5530',
  './new-matter-save.css?v=5530',
  './app.js?v=5530',
  './manifest.webmanifest?v=5530',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5530',
  ...
  './header-filter-premium.png?v=5530',
  './bg-new-matter-approved.webp?v=5530',
  './nm-folder-mockup.png?v=5530',
  './nm-scale-mockup.png?v=5530',
  './nm-doc-mockup.png?v=5530',
