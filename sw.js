const CACHE = 'advokat-iphone-offline-v121-premium-5491';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5491',
  './cases-folders.css?v=5491',
  './new-matter-client.css?v=5491',
  './new-matter-stage.css?v=5491',
  './new-matter-values.css?v=5491',
  './new-matter-save.css?v=5491',
  './app.js?v=5491',
  './manifest.webmanifest?v=5491',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5491',
  ...
  './header-filter-premium.png?v=5491',
  './bg-new-matter-approved.webp?v=5491',
  './nm-folder-mockup.png?v=5491',
  './nm-scale-mockup.png?v=5491',
  './nm-doc-mockup.png?v=5491',
