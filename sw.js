const CACHE = 'advokat-iphone-offline-v121-premium-5429';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5429',
  './bg-new-matter-approved.webp?v=5429',
  './nm-folder-mockup.png?v=5429',
  './nm-scale-mockup.png?v=5429',
  './nm-doc-mockup.png?v=5429',
