const CACHE = 'advokat-iphone-offline-v121-premium-5513';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5513',
  './cases-folders.css?v=5513',
  './new-matter-client.css?v=5513',
  './new-matter-stage.css?v=5513',
  './new-matter-values.css?v=5513',
  './new-matter-save.css?v=5513',
  './app.js?v=5513',
  './manifest.webmanifest?v=5513',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5513',
  ...
  './header-filter-premium.png?v=5513',
  './bg-new-matter-approved.webp?v=5513',
  './nm-folder-mockup.png?v=5513',
  './nm-scale-mockup.png?v=5513',
  './nm-doc-mockup.png?v=5513',
