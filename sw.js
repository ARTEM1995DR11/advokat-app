const CACHE = 'advokat-iphone-offline-v121-premium-5427';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5427',
  './bg-new-matter-approved.webp?v=5427',
  './nm-folder-mockup.png?v=5427',
  './nm-scale-mockup.png?v=5427',
  './nm-doc-mockup.png?v=5427',
