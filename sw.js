const CACHE = 'advokat-iphone-offline-v121-premium-5466';
...
const CORE = [
  ...
  './header-filter-premium.png?v=5466',
  './bg-new-matter-approved.webp?v=5466',
  './nm-folder-mockup.png?v=5466',
  './nm-scale-mockup.png?v=5466',
  './nm-doc-mockup.png?v=5466',
