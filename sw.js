const CACHE = 'advokat-iphone-offline-v121-premium-5518';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5518',
  './cases-folders.css?v=5518',
  './new-matter-client.css?v=5518',
  './new-matter-stage.css?v=5518',
  './new-matter-values.css?v=5518',
  './new-matter-save.css?v=5518',
  './app.js?v=5518',
  './manifest.webmanifest?v=5518',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5518',
  ...
  './header-filter-premium.png?v=5518',
  './bg-new-matter-approved.webp?v=5518',
  './nm-folder-mockup.png?v=5518',
  './nm-scale-mockup.png?v=5518',
  './nm-doc-mockup.png?v=5518',
