const CACHE = 'advokat-iphone-offline-v127-premium-5543';

const CORE = [
  './',
  './index.html',
  './styles.css?v=5543',
  './cases-folders.css?v=5543',
  './new-matter-client.css?v=5543',
  './new-matter-stage.css?v=5543',
  './new-matter-values.css?v=5543',
  './new-matter-save.css?v=5543',
  './app.js?v=5543',
  './manifest.webmanifest?v=5543',
  './VERSION.txt',
  ...
  './premium-gold-save-v5249.webp?v=5543',
  ...
  './header-filter-premium.png?v=5543',
  './bg-new-matter-approved.webp?v=5543',
  './nm-folder-mockup.png?v=5543',
  './nm-scale-mockup.png?v=5543',
  './nm-doc-mockup.png?v=5543',
