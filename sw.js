const CACHE = 'advokat-iphone-offline-v40-stable-5102';
const SHELL = [
  './',
  './index.html',
  './styles.css?v=5102',
  './nav-panel-light.png',
  './nav-active-base.png?v=5102',
  './nav-active-today.png?v=5102',
  './nav-active-tasks.png?v=5102',
  './nav-active-cases.png?v=5102',
  './nav-active-calendar.png?v=5102',
  './nav-active-more.png?v=5102',
  './app.js?v=5102',
  './manifest.webmanifest?v=5102',
  ...
  './header-bell-premium.png?v=5102',
  './header-search-premium.png?v=5102',
  './quick-sheet-marble-approved.png?v=5102',
  './quick-icon-hearing.png?v=5102',
  './quick-icon-meeting.png?v=5102',
  './quick-icon-deadline.png?v=5102',
  './quick-icon-task.png?v=5102',
  './quick-icon-journal.png?v=5102',
  './VERSION.txt'
];
