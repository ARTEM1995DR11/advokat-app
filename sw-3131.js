const CACHE = 'advokat-iphone-offline-v31-restyle-3131';
const SHELL = [
  './',
  './index.html',
  './styles-3131.css',
  './app-3131.js',
  './manifest-3131.webmanifest?v=3131',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3131.js') || url.pathname.endsWith('/styles-3131.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
