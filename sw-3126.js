const CACHE = 'advokat-iphone-offline-v31-restyle-3126';
const SHELL = [
  './',
  './index.html',
  './styles-3126.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3126.js') || url.pathname.endsWith('/styles-3126.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
