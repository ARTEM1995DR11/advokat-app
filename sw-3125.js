const CACHE = 'advokat-iphone-offline-v31-restyle-3125';
const SHELL = [
  './',
  './index.html',
  './styles-3125.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3125.js') || url.pathname.endsWith('/styles-3125.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
