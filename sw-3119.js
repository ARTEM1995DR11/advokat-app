const CACHE = 'advokat-iphone-offline-v31-restyle-3119';
const SHELL = [
  './',
  './index.html',
  './styles-3119.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3119.js') || url.pathname.endsWith('/styles-3119.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
