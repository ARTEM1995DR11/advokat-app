const CACHE = 'advokat-iphone-offline-v31-restyle-3129';
const SHELL = [
  './',
  './index.html',
  './styles-3129.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3129.js') || url.pathname.endsWith('/styles-3129.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
