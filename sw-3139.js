const CACHE = 'advokat-iphone-offline-v31-restyle-3139';
const SHELL = [
  './',
  './index.html',
  './styles-3139.css',
  './app-3139.js',
  './manifest-3139.webmanifest?v=3139',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3139.js') || url.pathname.endsWith('/styles-3139.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
