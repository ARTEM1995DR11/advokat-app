const CACHE = 'advokat-iphone-offline-v31-restyle-3123';
const SHELL = [
  './',
  './index.html',
  './styles-3123.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3123.js') || url.pathname.endsWith('/styles-3123.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
