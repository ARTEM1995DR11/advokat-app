const CACHE = 'advokat-iphone-offline-v31-restyle-3127';
const SHELL = [
  './',
  './index.html',
  './styles-3127.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3127.js') || url.pathname.endsWith('/styles-3127.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
