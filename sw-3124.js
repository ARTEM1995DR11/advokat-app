const CACHE = 'advokat-iphone-offline-v31-restyle-3124';
const SHELL = [
  './',
  './index.html',
  './styles-3124.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3124.js') || url.pathname.endsWith('/styles-3124.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
