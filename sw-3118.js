const CACHE = 'advokat-iphone-offline-v31-restyle-3118';
const SHELL = [
  './',
  './index.html',
  './styles-3118.css',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3118.js') || url.pathname.endsWith('/styles-3118.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
