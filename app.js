...
function ico(n,c){
  /* 5.0.246: inline SVG geometry instead of <use href="#...">.
...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.webp?v=5246" alt="Весы правосудия"></span><i></i></div>';
}
...
/* =====================================================================
   ...
   ===================================================================== */
var ED = null;
/* 5.0.246 — new task/meeting titles are manual-only. */
...
function editTask(t,preset){
  ...
  /* 5.0.246: new task/meeting title is always manual-only. */
...
function renderQuickEntryTop190(title,currentKind){
  ...
  return '<section class="qe190-top qe190-kind-'+esc(currentKind)+'">'+
    '<div class="qe190-brand"><img src="scale-gold.webp?v=5246" alt="Весы правосудия"><div class="qe190-brand-copy"><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  ...
  var art={
    'qa-hearing':'quick-card-hearing-v5100.png?v=5246',
    'qa-meeting':'quick-card-meeting-v5100.png?v=5246',
    'qa-deadline':'quick-card-deadline-v5100.png?v=5246',
    'qa-task':'quick-card-task-v5100.png?v=5246',
    'qa-journal':'quick-card-journal-v5100.png?v=5246'
  }[act]||'';
  if(art){
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5246':type==='search'?'header-search-premium.png?v=5246':type==='plus'?'fab-plus-square-premium.png?v=5246':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="gs166 gs153">'+
    '<header class="gs166-head gs153-head">'+
      ...
      '<img class="gs166-head-motif" src="global-search-head-motif-v173.png?v=5246" alt="" aria-hidden="true">'+
    '</header>'+
    ...
    '<div class="gs166-main gs153-main">'+
      ...
      '</div>'+
    '</div>'+
    '<footer class="gs166-footer gs153-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5246" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></footer>'+
  '</section>');
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5246" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5246" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
...
/* 5.0.246 — distinguish real typing/paste from Safari restoration. */
...
function afterUnlock(){
  if(!unlocked)return;
  /* 5.0.246: a stale invisible scrim must never block taps after launch. */
  try{
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    /* 5.0.246 STARTUP-STABILITY:
       register only after the UI is already usable; do not force an update,
       reload, navigation or controller switch during launch. */
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5246',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
