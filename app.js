...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5141" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5141" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5141':type==='search'?'header-search-premium.png?v=5141':type==='plus'?'fab-plus-square-premium.png?v=5141':'';
  ...
  openSheet('<section class="gs135">'+
    '<header class="gs135-head">'+
      ...
      '<div class="gs135-head-decor" aria-hidden="true">'+
        ...
        '<img class="gs135-medallion" src="search-medallion.png?v=5141" alt="">'+
      '</div>'+
    '</header>'+
    ...
    '<div class="gs135-main">'+
      ...
      '</div>'+
    '</div>'+
    '<footer class="gs135-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5141" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></footer>'+
  '</section>');
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5141" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5141" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw.js?v=5141', {updateViaCache:'none'}).then(function(reg){
