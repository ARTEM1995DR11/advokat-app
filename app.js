...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5118" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5118" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  var art={
    'qa-hearing':'quick-icon-hearing.png?v=5118',
    'qa-meeting':'quick-icon-meeting.png?v=5118',
    'qa-deadline':'quick-icon-deadline.png?v=5118',
    'qa-task':'quick-icon-task.png?v=5118',
    'qa-journal':'quick-icon-journal.png?v=5118'
  }[act]||'';
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5118':type==='search'?'header-search-premium.png?v=5118':type==='plus'?'fab-plus-square-premium.png?v=5118':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="g118">'+
    '<div class="g118-head">'+
      ...
      '<div class="g118-orb" aria-hidden="true"><span>'+ico('search','s')+'</span></div>'+
    '</div>'+
    ...
    '<div class="g118-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5118" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></div>'+
  '</section>');
  $('#sheet').classList.add('global-search-approved-v118-sheet');
  renderGlobalSearch();
  setTimeout(function(){var e=$('#gq');if(e)e.focus();},260);
}
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5118" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5118" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
