...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5121" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5121" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  var art={
    'qa-hearing':'quick-icon-hearing.png?v=5121',
    'qa-meeting':'quick-icon-meeting.png?v=5121',
    'qa-deadline':'quick-icon-deadline.png?v=5121',
    'qa-task':'quick-icon-task.png?v=5121',
    'qa-journal':'quick-icon-journal.png?v=5121'
  }[act]||'';
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5121':type==='search'?'header-search-premium.png?v=5121':type==='plus'?'fab-plus-square-premium.png?v=5121':'';
...
function globalSearchApprovedExamples(){
  return '<div class="g118-example-title"><span></span><b>ПРИМЕРЫ ЗАПРОСОВ</b><span></span></div>'+    '<div class="g118-chips">'+      searchPremiumChip('Ошарин','Ошарин','user')+      searchPremiumChip('81 УК','81 УК','doc')+      searchPremiumChip('Ивановский суд','Ивановский суд','brief')+      searchPremiumChip('А56-12345/2024','А56-12345/2024','doc')+      searchPremiumChip('ст. 318 УК','ст. 318 УК','scale')+      searchPremiumChip('заседание завтра','заседание завтра','cal')+      searchPremiumChip('доверенность','доверенность','doc')+    '</div>';
}
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="g120">'+
    '<div class="g120-head">'+
      ...
      '<svg class="g120-ribbons" viewBox="0 0 220 188" aria-hidden="true"><path d="M19 -15 C54 45 77 93 130 117 C177 139 202 151 238 190"/><path d="M34 -18 C70 38 91 84 143 108 C187 129 216 145 250 182"/></svg>'+
      '<img class="g120-medallion" src="search-medallion-approved-v121.png?v=5121" alt="">'+
    '</div>'+
    ...
    '<div class="g120-helper" id="ghelper">'+
      '<div class="g120-helper-star"><span>✦</span></div>'+
      ...
      '<button type="button" class="g120-close" data-act="global-search-clear-tip" aria-label="Закрыть подсказку">'+ico('xmark','s')+'</button>'+
    '</div>'+
    '<div class="g120-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5121" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></div>'+
  '</section>');
  $('#sheet').classList.add('global-search-approved-v121-sheet');
  renderGlobalSearch();
}
function renderGlobalSearch(){
  ...
  var exTitle=document.querySelector('.g118-example-title');
  var exChips=document.querySelector('.g118-chips');
  var q=(GQ||'').trim();
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5121" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5121" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
