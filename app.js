...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.webp?v=5171" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.webp?v=5171" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  ...
  var art={
    'qa-hearing':'quick-card-hearing-v5100.png?v=5171',
    'qa-meeting':'quick-card-meeting-v5100.png?v=5171',
    'qa-deadline':'quick-card-deadline-v5100.png?v=5171',
    'qa-task':'quick-card-task-v5100.png?v=5171',
    'qa-journal':'quick-card-journal-v5100.png?v=5171'
  }[act]||'';
  if(art){
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5171':type==='search'?'header-search-premium.png?v=5171':type==='plus'?'fab-plus-square-premium.png?v=5171':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="gs166 gs153">'+
    '<header class="gs166-head gs153-head">'+
      ...
      '<img class="gs166-head-motif" src="global-search-head-motif-v169.png?v=5171" alt="" aria-hidden="true">'+
    '</header>'+
    ...
    '<div class="gs166-main gs153-main">'+
      ...
      '</div>'+
    '</div>'+
    '<footer class="gs166-footer gs153-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5171" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></footer>'+
  '</section>');
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5171" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5171" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw.js?v=5171', {updateViaCache:'none'}).then(function(reg){
