...
function renderToday(){
  ...
  var html =
    '<div class="today-brand"><div class="today-brand-left"><span class="today-logo"><img src="scale-gold.png?v=4043" alt="Весы правосудия"></span><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function renderCal(){
  ...
  var html='<div class="calendar-project">'+
    '<div class="today-brand"><div class="today-brand-left"><span class="today-logo"><img src="scale-gold.png?v=4043" alt="Весы правосудия"></span><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div><div class="today-actions"><button class="iconbtn" data-act="global-search" title="Поиск">'+ico('search')+'</button></div></div>'+
...
function drawEditor(){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=4043" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
/* =====================================================================
   Swipe по задачам / встречам / срокам / прошедшим заседаниям — 4.0.43
