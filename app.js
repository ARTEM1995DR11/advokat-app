...
function sheetMatterFilters(){
  ...
  openSheet(
    '<div class="matter-filter-premium-head">'+
      '<span class="matter-filter-brand-mark"><img src="scale-gold.webp?v=5312" alt=""></span>'+
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5312',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
