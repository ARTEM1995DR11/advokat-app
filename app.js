...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5109" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5109" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  var art={
    'qa-hearing':'quick-icon-hearing.png?v=5109',
    'qa-meeting':'quick-icon-meeting.png?v=5109',
    'qa-deadline':'quick-icon-deadline.png?v=5109',
    'qa-task':'quick-icon-task.png?v=5109',
    'qa-journal':'quick-icon-journal.png?v=5109'
  }[act]||'';
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5109':type==='search'?'header-search-premium.png?v=5109':type==='plus'?'fab-plus-square-premium.png?v=5109':'';
...
function sheetNotify(){
  ...
  openSheet('<section class="rem107">'+
    '<header class="rem107-head">'+
      ...
      '<img class="rem107-head-bell" src="reminder-approved-top-bell.png?v=5109" alt="">'+
    ...
    '<article class="rem107-card rem107-card-local">'+
      '<img class="rem107-card-icon" src="reminder-approved-card-bell.png?v=5109" alt="">'+
    ...
    '<article class="rem107-card rem107-card-calendar">'+
      '<img class="rem107-card-icon" src="reminder-approved-card-calendar.png?v=5109" alt="">'+
    ...
    '<footer class="rem107-footer"><span></span><img src="reminder-approved-footer-scales.png?v=5109" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
