...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5382',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
...
function matterApprovedBadge(m){
  ...
  /* 5.0.382: бейдж «Сегодня» в карточке дела убран как лишний —
