...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5165" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5165" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  ...
  var art={
    'qa-hearing':'quick-card-hearing-v5100.png?v=5165',
    'qa-meeting':'quick-card-meeting-v5100.png?v=5165',
    'qa-deadline':'quick-card-deadline-v5100.png?v=5165',
    'qa-task':'quick-card-task-v5100.png?v=5165',
    'qa-journal':'quick-card-journal-v5100.png?v=5165'
  }[act]||'';
  if(art){
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5165':type==='search'?'header-search-premium.png?v=5165':type==='plus'?'fab-plus-square-premium.png?v=5165':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="gs165 gs153">'+
    '<header class="gs165-head gs153-head">'+
      '<div class="gs165-head-copy gs153-head-copy"><h2>Глобальный поиск</h2><p><span>Доверители, номера дел, суды, статьи,</span><span>задачи и журнал.</span></p></div>'+
      '<img class="gs165-head-motif" src="global-search-head-motif-v165.png?v=5165" alt="" aria-hidden="true">'+
    '</header>'+
    '<div class="gs165-searchwrap">'+
      '<label class="gs165-search gs153-search" for="gq">'+
      ...
      '</label>'+
    '</div>'+
    '<div class="gs165-tip gs153-info" id="gsearch-tip">'+
    ...
    '</div>'+
    '<div class="gs165-main gs153-main">'+
      '<div class="gs165-examples gs153-examples">'+
        '<div class="gs165-section-title gs153-example-title"><span></span><b>ПРИМЕРЫ ЗАПРОСОВ</b><span></span></div>'+
        '<div class="gs165-chiprows gs153-chiprows">'+
          '<div class="gs165-chiprow gs153-chiprow gs153-chiprow-1">'+
            searchPremiumChip('Ошарин','Ошарин','user')+
            searchPremiumChip('81 УК','81 УК','page')+
            searchPremiumChip('Ивановский суд','Ивановский суд','court')+
          '</div>'+
          '<div class="gs165-chiprow gs153-chiprow gs153-chiprow-2">'+
            searchPremiumChip('А56-12345/2024','А56-12345/2024','page')+
            searchPremiumChip('ст. 318 УК','ст. 318 УК','scale-line')+
          '</div>'+
          '<div class="gs165-chiprow gs153-chiprow gs153-chiprow-3">'+
            searchPremiumChip('заседание завтра','заседание завтра','cal')+
            searchPremiumChip('доверенность','доверенность','doc')+
          '</div>'+
        '</div>'+
      '</div>'+
      '<div id="gresults" class="gs165-results gs153-results search-premium-results"></div>'+
      '<div class="gs165-helper gs153-helper" id="ghelper">'+
      ...
      '</div>'+
    '</div>'+
    '<footer class="gs165-footer gs153-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5165" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></footer>'+
  '</section>');
  $('#sheet').classList.add('global-search-premium-v165-sheet');
  renderGlobalSearch();
}
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5165" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5165" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw.js?v=5165', {updateViaCache:'none'}).then(function(reg){
