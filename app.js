...
function saveTask(){
  /* 5.0.418: "Заседание" is strictly a judicial event. */
  try{
    var kindEl=$('#e-kind');
    var midEl=$('#e-mid');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5418',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
