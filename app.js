...
/* =====================================================================
   iOS PWA COLD-START NAV FIX (5.0.89)
   Навигация фиксируется CSS к viewport. Здесь только безопасно просим
   WebKit обновить fixed-layout после pageshow/возврата из фона, не меняя
   высоту html/body и не используя screen.height.
   ===================================================================== */
...
document.addEventListener('visibilitychange',function(){if(!document.hidden)requestAnimationFrame(refreshFixedChrome);},{passive:true});
window.addEventListener('orientationchange',function(){setTimeout(refreshFixedChrome,100);},{passive:true});
