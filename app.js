...
function renderMore(){
  ...
  var html='<div class="more-project">'+
    ...
    '</div>'+
    '<div class="settings-footnote">Ежедневник адвоката · iPhone Offline 4.0.6<br>'+esc(offlineStatusText())+'<br>Рабочая база хранится локально в зашифрованном виде.</div>'+
  '</div>';
