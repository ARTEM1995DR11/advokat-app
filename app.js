...
function matterEditorControlIconName(id){
  var map={
    'm-type':'scale','m-basis':'doc','m-client':'user','m-phone':'phone','m-number':'brief',
...
function saveTask(){
  /* 5.0.405: "Заседание" is strictly a judicial event. */
  try{
    var kindEl=$('#e-kind');
    var midEl=$('#e-mid');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5405',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
