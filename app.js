...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5158" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5158" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  ...
  var art={
    'qa-hearing':'quick-card-hearing-v5100.png?v=5158',
    'qa-meeting':'quick-card-meeting-v5100.png?v=5158',
    'qa-deadline':'quick-card-deadline-v5100.png?v=5158',
    'qa-task':'quick-card-task-v5100.png?v=5158',
    'qa-journal':'quick-card-journal-v5100.png?v=5158'
  }[act]||'';
  if(art){
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5158':type==='search'?'header-search-premium.png?v=5158':type==='plus'?'fab-plus-square-premium.png?v=5158':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="gs153">'+
    '<header class="gs153-head">'+
      ...
      '<img class="gs158-head-motif" src="global-search-head-motif-v153.png?v=5158" alt="" aria-hidden="true">'+
    '</header>'+
    ...
    '<div class="gs153-main">'+
      ...
      '</div>'+
    '</div>'+
    '<footer class="gs153-footer"><span></span><img src="reminder-footer-scales-exact.png?v=5158" alt=""><span></span><b>ПРАВО И ПОРЯДОК</b></footer>'+
  '</section>');
  $('#sheet').classList.add('global-search-approved-v158-sheet');
  renderGlobalSearch();
}
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5158" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5158" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw.js?v=5158', {updateViaCache:'none'}).then(function(reg){
