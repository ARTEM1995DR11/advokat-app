...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.png?v=5125" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawEditor(preserveScroll){
  ...
  openSheet(
  '<div class="task-editor-brand"><img src="scale-gold.png?v=5125" alt="Весы правосудия"><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function quickItem(i,t,act,tone){
  var art={
    'qa-hearing':'quick-icon-hearing.png?v=5125',
    'qa-meeting':'quick-icon-meeting.png?v=5125',
    'qa-deadline':'quick-icon-deadline.png?v=5125',
    'qa-task':'quick-icon-task.png?v=5125',
    'qa-journal':'quick-icon-journal.png?v=5125'
  }[act]||'';
...
function premiumActionIcon(type,cls){
  ...
  var src=type==='bell'?'header-bell-premium.png?v=5125':type==='search'?'header-search-premium.png?v=5125':type==='plus'?'fab-plus-square-premium.png?v=5125':'';
...
function sheetGlobalSearch(){
  ...
  openSheet('<section class="g120">'+
    '<div class="g120-head">'+
      ...
      '<div class="g125-head-decor" aria-hidden="true">        <svg class="g125-ribbons" viewBox="0 0 180 190" preserveAspectRatio="none">          <path d="M18 -8 C44 24 48 56 82 84 C112 109 145 120 174 158"/>          <path d="M40 -8 C63 25 68 52 96 74 C126 98 153 108 184 141"/>        </svg>        <img class="g125-medallion" src="search-medallion-approved-v121.png?v=5125" alt="">      </div>'+
    '</div>'+
  ...
  '</section>');
  $('#sheet').classList.add('global-search-approved-v125-sheet');
  renderGlobalSearch();
}
...
function sheetNotify(){
  ...
  openSheet('<section class="rem116">'+
    '<header class="rem116-head">'+
      ...
      '<img class="rem116-head-motif" src="reminder-head-motif-exact.png?v=5125" alt="">'+
    '</header>'+
    ...
    '<footer class="rem116-footer"><span></span><img class="rem116-footer-scale" src="reminder-footer-scales-exact.png?v=5125" alt=""><span></span><b>ДЕЛА В ПОРЯДКЕ</b></footer>'+
  '</section>');
