...
function headerMatterFilter(active){
  ...
  return '<button class="'+cls+'" style="'+style+'" data-act="matter-filter-sheet" title="Фильтры и сортировка" aria-label="Фильтры и сортировка" type="button"><img class="premium-action-art" src="header-filter-premium.png?v=5390" alt=""></button>';
}
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5390',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
