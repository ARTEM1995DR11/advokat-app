...
function renderPremiumListPicker(){
  ...
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.webp?v=5196" alt="Весы правосудия"></span><i></i></div>';
}
...
function renderQuickEntryTop190(title,currentKind){
  ...
  return '<section class="qe190-top qe190-kind-'+esc(currentKind)+'">'+
    '<div class="qe190-brand"><img src="scale-gold.webp?v=5196" alt="Весы правосудия"><div class="qe190-brand-copy"><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
