...
function renderPremiumListPicker(){
  ...
  var headIconHtml=isCourtPicker?'<span class="premium-list-head-icon premium-court-head-scales"><img src="scale-gold.webp?v=5357" alt="Весы правосудия"></span>':'<span class="premium-list-head-icon">'+ico(LIST_PICKER.meta.icon||'list')+'</span>';
  modal.innerHTML='<div class="premium-list-grab"></div>'+ 
    ...
    '<div class="premium-list-sign"><i></i><span><img class="premium-list-sign-logo" src="scale-gold.webp?v=5357" alt="Весы правосудия"></span><i></i></div>';
}
...
function drawHearingResultSheet(){
  ...
  openSheet('<div class="hearing-result-v355-head">'+
    ...
    '<div class="hearing-result-v355-sign" aria-hidden="true"><i></i><span><img src="scale-gold.webp?v=5357" alt="Весы правосудия"></span><i></i></div>');
  var sheet=$('#sheet');
...
function sheetMatterFilters(){
  ...
  openSheet(
    '<div class="matter-filter-premium-head">'+
      '<span class="matter-filter-brand-mark"><img src="scale-gold.webp?v=5357" alt=""></span>'+
...
function renderQuickEntryTop190(title,currentKind){
  ...
  return '<section class="qe190-top qe190-kind-'+esc(currentKind)+(editTitle?' qe190-mode-edit':' qe190-mode-create')+'">'+
    '<div class="qe190-brand"><img src="scale-gold.webp?v=5357" alt="Весы правосудия"><div class="qe190-brand-copy"><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    setTimeout(function(){
      navigator.serviceWorker.register('./sw.js?v=5357',{updateViaCache:'none'})
        .catch(function(){});
    },1400);
  });
}
