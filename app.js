...
function renderMore(){
  ...
  '</div>'+
  '<div class="footnote">Ежедневник адвоката · Signature 3.8<br>'+esc(offlineStatusText())+'<br>Рабочая база хранится локально в зашифрованном виде.</div>';
...
/* =====================================================================
   ...
   ===================================================================== */
function showIntro(){
  openSheet('<h2>Ежедневник адвоката 3.8 Signature</h2><p class="sh-sub">Локальный рабочий кабинет для дел, заседаний, сроков и задач.</p>'+iphoneInstallHint()+
  '<div class="card pad0">'+
