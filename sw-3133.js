const CACHE = 'advokat-iphone-offline-v31-restyle-3133';
const SHELL = [
  './',
  './index.html',
  './styles-3133.css',
  './app-3133.js',
  './manifest-3133.webmanifest?v=3133',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/app-3133.js') || url.pathname.endsWith('/styles-3133.css') || url.pathname.endsWith('/VERSION.txt')) {
    event.respondWith(
      fetch(req, {cache:'no-store'}).then(response => {
