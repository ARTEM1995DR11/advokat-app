...
function sheetTaskActions(id){
  ...
  openSheet('<h2>Быстрые действия</h2><p class="sh-sub">'+esc(t.title)+' · '+esc(sub)+'</p><div class="card pad0 task-action-sheet">'+rows+'</div>');
}
...
function renderMatters(){
  ...
  var html='<div class="matters-project">'+
    '<div class="today-brand"><div class="today-brand-left"><span class="today-logo"><img src="scale-gold.png?v=328" alt="Весы правосудия"></span><div><b>Ежедневник адвоката</b><small>Больше, чем календарь</small></div></div>'+
...
function renderMore(){
  ...
  '</div>'+
  '<div class="footnote">Ежедневник адвоката · iPhone Offline 3.1.27<br>'+esc(offlineStatusText())+'<br>Рабочая база хранится локально в зашифрованном виде.</div>';
...
if('serviceWorker' in navigator){
  window.addEventListener('load',function(){
    ...
    navigator.serviceWorker.register('./sw-3128.js', {updateViaCache:'none'}).then(function(reg){
